...
description: Consulte las listas de precios actuales para servicios basados en licencias como Office 365, Microsoft Dynamics CRM y Enterprise Mobility Suite, y servicios basados en el uso como Azure.
author: BrentSerbus
ms.author: brserbus
...
Para ver las ofertas y programas Proveedor de soluciones en la nube (CSP) más recientes, en el panel del Portal de partners, vaya a **Sell > Pricing and Offers (Precios y ofertas de Sell >).** Encontrará listas de precios independientes para los distintos tipos de productos que están disponibles. Las siguientes listas de precios están disponibles en la página **Precios y ofertas**:

- **Los servicios basados en licencias** incluyen información de precios para Office 365, Enterprise Mobility y Security E3 y Dynamics 365. La sección precios basados en licencias incluye los precios actuales y en versión preliminar y la matriz de la lista de ofertas. Las listas de precios incluyen el precio de la lista y los precios de venta al por menor estimados (ERP) para las ofertas en todas las monedas admitidas. La matriz de lista de ofertas incluye disponibilidad del mercado y otra información importante sobre las ofertas. Estos archivos se actualizan el primer día de cada mes.
- **Los servicios basados en el** uso incluyen información de precios Microsoft Azure y Visual Studio. También puedes usar la [Calculadora de precios de servicios de Azure en el CSP](https://azure.microsoft.com/pricing/calculator/). La descarga basada en el uso incluye las listas de precios de CSP para todas las monedas admitidas y los archivos de precios de servicios compartidos en ERP. Estos archivos se actualizan el primer día de cada mes.
...
- **Las suscripciones de software** incluyen los precios de las suscripciones de software basadas en términos para todas las monedas admitidas. El archivo de precios incluye todas las monedas admitidas con el precio de lista y el precio de venta sugerido por el fabricante (MSRP). Estos archivos se actualizan el primer día de cada mes.
- **Los precios del plan de Azure** incluyen información de precios para los servicios de consumo del plan de Azure y los precios de las reservas del plan de Azure. Los precios son precios directos o ERP y se pueden recuperar para cualquier mercado admitido determinado. Los datos de estos archivos se actualizan todos los días.
...
- **Marketplace** incluye precios para soluciones de proveedores de software independientes (ISV) del marketplace comercial de Microsoft. Los precios se recuperan por mercado. Los datos de estos archivos se actualizan todos los días.
...
Los servicios basados en licencias incluyen una versión preliminar de la lista de precios, que se proporciona con 30 días de antelación a los cambios. Para ver la versión preliminar de la lista de precios, vaya a **Sell > Pricing and offers (Precios y ofertas de Sell >).** No hay ninguna versión preliminar de precios para los servicios basados en el uso, ya que estos servicios son dinámicos. En la tabla siguiente se explica cómo leer la tabla de lista de precios.

|**Elemento**        |**Definición**      |
|:-----------   |:-----------   |
|ADD   |Nuevo elemento de la lista de precios|
...
Los cambios en el precio son una repetición común. Los asociados pueden anticipar los cambios en los precios de las ofertas basadas en licencias si miran la versión preliminar de la lista de precios. En el Centro de partners, abra la página Precios y ofertas para ver la vista previa de la lista de precios.

Sin embargo, los precios basados en el uso de Azure no tienen ninguna versión preliminar. Los asociados pueden mantenerse al día con los cambios en los precios de consumo de Azure mediante la API de RateCard, que devuelve los precios de los medidores de ese día.
...
|Software||No disponible|Comparación manual de las listas de precios de un mes a otro|
|Reservations|Máquinas virtuales, de pago por pagar|No disponible|Comparación manual de las listas de precios de un mes a otro|
...
Los servicios basados en licencias se pueden adquirir como ofertas base o complementos. Solo las ofertas base son reconocibles y comprables a través del catálogo Centro de partners base. Debe aplicar complementos después de adquirir las ofertas base. La lista de precios basados en licencias **Columna de tipo de** licencia secundaria incluye información sobre cada oferta y su tipo. Las ofertas base **tienen valores no específicos** en la columna tipo de licencia secundaria de la lista de precios y se pueden adquirir en el catálogo. Los valores de tipo de licencia **secundario del complemento** no se pueden adquirir en el catálogo. Para comprar estos complementos:

1. Consulte la matriz de lista de ofertas para ver la lista de los IDs de oferta que deben adquirirse antes de poder comprar un complemento.
2. Compra de la oferta base en el catálogo
3. Vaya a su cliente desde la lista de clientes. Seleccione la suscripción de la oferta base que acaba de comprar. En la página Administrar suscripción, verá complementos disponibles que se pueden aplicar a la oferta base.
...
Estas restricciones de compra se definen como parte de la configuración de la oferta y se pueden encontrar buscando en la matriz de lista de ofertas. Dos columnas de datos funcionan juntas para definir el cumplimiento: 1. Ámbito de límite de la oferta y 2. Límite de la oferta. Las restricciones se aplican durante una compra. El catálogo del Centro de partners no permitirá que un asociado compre más ofertas de las que permiten las reglas. Cualquier intento de infringir las restricciones producirá un error.
...
- Las ofertas **con None** se pueden adquirir sin restricciones.
- **Las ofertas** de duración solo se pueden adquirir una vez.
- **Las** ofertas simultáneas se pueden adquirir tantas veces como permita el valor **límite** de la oferta para esa oferta. La mayoría de las pruebas tienen un ámbito de límite de la oferta de duración con un límite de oferta de "1". La mayoría de las ofertas empresariales pequeñas tienen un ámbito de límite de oferta simultáneo con un límite de oferta de "2".
...
Todos los precios de las listas de precios de CSP del Centro de partners incluyen impuestos. Para obtener más información en el documento Centro de partners [impuestos y exenciones fiscales](tax-and-tax-exemptions.md).
...
- La renovación anual estará al precio del tiempo de compra durante el período de tres años
...
- Las suscripciones de las ofertas de 72 meses A1 se bloquean después de la compra y no se pueden cancelar y los recuentos de licencias no se pueden agregar a la suscripción después de la compra inicial.
...
La mayoría de las listas de precios incluyen un precio de lista, el precio que se factura al asociado y el precio de venta al por menor estimado. El precio de venta al por menor estimado (ERP) también se denomina precio de venta sugerido por Microsoft o MSRP. Estos dos valores, ERP y MSRP, representan el valor de mercado estimado de los productos si un cliente comprara los productos directamente a Microsoft. A continuación se muestra dónde encontrar los detalles de ERP/MSRP para cada tipo de producto o servicio. 


|**Producto o servicio**        |**Detalles de la lista de precios de ERP y MSRP**      |
|:-----------   |:-----------   |
|Producto o servicio  |Detalles de la lista de precios de ERP y MSRP  |
|Servicios basados en licencias  |Se muestra como ERP en las listas de precios basados en licencias.  |
...
|Basado en el uso del plan de Azure  |Los precios son comerciales, sin descuento en las hojas de precios  |
