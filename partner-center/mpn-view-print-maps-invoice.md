...
1.  Inicie sesión en el centro de Partners con su cuenta profesional y seleccione **MPN** en el menú de la izquierda.
...
1.  En centro de Partners, seleccione Configuración de la **cuenta**.
    -   Para buscar el identificador de Microsoft, seleccione Perfil de la **organización**.
...
3.  Rellena el formulario. En **tipo de problema**, seleccione **no se puede administrar mi perfil**. En la descripción, incluye tu Id. de MPN y de Microsoft.
...
1.  En centro de Partners, seleccione las **ofertas**de pertenencia y, a continuación, seleccione **disponible**. 
