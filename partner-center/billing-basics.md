...
## <a name="bill-your-customers"></a>Facturación a los clientes
...
Entre los tipos de facturación del Centro de partners se incluyen la **facturación basada en licencia**, la **facturación basada en uso** y la **facturación de un solo uso**. Para más información, consulta la explicación completa de los [tipos de facturación del Centro de partners](billing-different-types.md).

### <a name="billing-currency"></a>Divisa de facturación
...
La factura es un resumen de todos los cargos del período de facturación actual. Se incluyen los cargos de todo el programa, todos los productos y todos los clientes. Para ver ejemplos de escenarios de facturación mensuales y anuales, consulta los [escenarios comunes de facturación](common-billing-scenarios.md).

Para la facturación basada en el uso y en la licencia, la factura estará disponible en un plazo de dos (2) días a partir de la fecha de facturación seleccionada, en la hora UTC. Por ejemplo, si tienes una fecha de facturación de 12 de septiembre, el proceso de generación de la factura comenzará a las 12:00 a. m. UTC del día 13 y terminará a las 12:00 a. m. UTC del día 14. 

En el caso de la facturación única y periódica, el período de facturación se alinea con el mes natural y los archivos de facturación o conciliación estarán disponibles no más tarde del día 8 de cada mes. Para obtener más información, consulta la [facturación de planes de Azure](azure-plan-billing.md). 
...
Los **precios basados en uso** pueden cambiar cada mes.

**Los precios de los productos, servicios y suscripciones de software** están garantizados durante el tiempo que dure la suscripción. Sin embargo, los precios pueden cambiar en la renovación.

Verás los **ajustes** y los **créditos** por período vencido en tu siguiente factura, después de la aplicación del crédito o ajuste.
...
Los impuestos se calculan según tu información (no la de los clientes), ya que la relación de facturación es entre Microsoft y tú. Puedes enviar tu identificador de contribuyente durante el proceso de configuración de la cuenta o a través de una solicitud de soporte técnico más adelante. Verás los cambios reflejados en el próximo ciclo de facturación.

Para **exenciones de impuestos sobre las ventas y retenciones**, tienes que enviar la documentación fiscal a través de una solicitud de soporte técnico. Verás los cambios y los reembolsos apropiados en tu siguiente ciclo de facturación. Más información sobre [el envío de retención de impuestos](withholding-tax-credit-form.md). 

Para **exenciones del impuesto sobre el valor añadido (IVA)** , tienes que enviar tu NIF (validado por Microsoft) a través de una solicitud de servicio.  Si se envía el CIF después de la configuración de la cuenta (mediante una solicitud de soporte técnico), las facturas anteriores a dicha solicitud no tendrán el CIF indicado en el PDF de la factura. Verás los cambios en el próximo ciclo de facturación.
...
[REDONDEO ((REDONDEO (Precio unitario * Cantidad / Número de días en el mes prorrateado, 2) * Número de días prorrateados) / Cantidad, 2) * Cantidad] 
...
#### <a name="annual-billing-rules"></a>Reglas de facturación anual 
...
- Se factura o acredita por período vencido para cualquier cambio en el número de licencias (cálculo prorrata según el número de licencias-días). El cálculo prorrateado usa la fórmula siguiente: 

  - [REDONDEO ((REDONDEO (Precio unitario * Cantidad / Número de días en el mes prorrateado, 2) * Número de días prorrateados) / Cantidad, 2) * Cantidad] 

- Los pagos se facturan por licencias vendidas, no licencias aprovisionadas. 

#### <a name="monthly-billing-rules"></a>Reglas de facturación mensual 

- Las suscripciones son mensuales y se renuevan automáticamente según las nuevas tarifas de servicio de uso medido. Se te facturará cada mes el uso del mes anterior. 
...
Puede que tengas que solicitar un crédito o una nueva facturación por los siguientes motivos:

- Tienes que hacer correcciones en la dirección o el pedido de compra.
