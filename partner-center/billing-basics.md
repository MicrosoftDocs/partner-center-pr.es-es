---
title: Información general de facturación | El centro de partners
ms.topic: article
ms.date: 10/29/2018
...
Están impuestos en función de tu información (no tus clientes) como la relación de facturación es entre tú y Microsoft. Puedes enviar tu NIF durante el proceso de configuración de cuenta o, envía una solicitud de soporte más adelante. Verás los cambios reflejados en el próximo ciclo de facturación.

-   Para retención y de exención de impuestos de ventas, debes enviar documentación fiscal a través de una solicitud de soporte técnico. Verás los cambios y los reembolsos apropiados en tu siguiente ciclo de facturación.

-   Para exenciones del impuesto sobre el valor agregado (IVA), tienes que enviar tu NIF/NIF (validado por Microsoft) a través de una solicitud de servicio. Verás los cambios y los reembolsos apropiados en tu siguiente ciclo de facturación.

Puedes encontrar más información fiscal de la oficina de impuestos local o asesor fiscal.
...
-   Facturación está en 12 pagos mensuales o un pago anual por suscripción anual.
...
-   Los pagos se facturarán por las licencias vendidas (no licencias aprovisionadas).
...
Microsoft no cobran tarifas por finalización anticipada de cancelación de servicios basados en licencia. 
...
-   Las tarifas de servicio de uso medido pueden cambiar durante el ciclo de facturación. 
    ...
    -   Las nuevas suscripciones, cuando se crean dentro del mismo ciclo de facturación, usan la tarifa en vigor en la fecha de que crearlos. 

### <a name="adjustmentscreditscancellations"></a>Ajustes/Créditos/Cancelaciones

Verás los pagos con ajustes en la siguiente factura de facturación mensual.

Microsoft no cobran tarifas por finalización anticipada de cancelación de servicios basados en uso. 
...
**Ver el estado actual de facturación, facturas y archivos de conciliación**

1.  En el centro de partners, selecciona la **facturación** y, a continuación, **una vez** para ver el estado de facturación. 
