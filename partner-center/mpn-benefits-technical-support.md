...
2.  Servicios técnicos de preventa e implementación (TPD): [más información](https://docs.microsoft.com/partner-center/technical-benefits)

**Este artículo está para los miembros de Microsoft Partner Network Partners (MPN) que necesitan saber cómo se puede crear un incidente de soporte técnico mediante las ventajas de asociados de MPN.**

## <a name="view-and-activate-your-technical-support-benefits"></a>Visualización y activación de las ventajas de soporte técnico

En primer lugar, debe activar y, a continuación, ver el identificador de acceso y el identificador de contrato, que le permiten asociar las ventajas a su cuenta. Use su cuenta para iniciar sesión en el portal de soporte técnico pertinente y crear una solicitud de soporte técnico.

Para ver y activar sus ventajas técnicas en Centro de partners:
...
2. Expanda **Beneficios** en el menú de navegación izquierdo y seleccione **Ventajas técnicas**. Aparece la página de las ventajas técnicas con una lista de las ventajas de soporte técnico disponibles para las ofertas Gold, Silver o Microsoft Action Pack.
   ...
   > [!NOTE]
   > Si no tiene ninguna oferta de pertenencia activa, verá el mensaje "Parece que aún no tiene ninguna beneficios". Si su empresa tiene ofertas de suscripción activas, pero no las puede ver, ha iniciado sesión con la cuenta incorrecta. Para comprobar la cuenta, seleccione el icono **Cuenta** en la parte superior derecha de la página y seleccione Iniciar sesión **con otra** cuenta (si es necesario).

3. Para usar soporte técnico de productos de Microsoft o soporte técnico para productos de firma, debe activar la ventaja. Para activar la ventaja, haga clic en **el botón** Activar. La cuenta de usuario usada para la activación requiere los roles Administrador global o Administrador de asociados de MPN. 
...
El soporte técnico proporciona solución de problemas para un problema específico, un mensaje de error o una funcionalidad que no funciona según lo previsto.
...
Puede usar soporte **técnico de Microsoft** para soporte técnico en productos locales recientes.
...
Cuando use el Azure Portal, use Soporte técnico Signature Cloud seleccionando Ayuda y soporte técnico, Planes de soporte técnico y, a continuación, "Vincular ventajas de soporte técnico" y escriba el identificador de acceso y el identificador de contrato.

> [!NOTE]
> Si tiene Microsoft Action Pack no obtiene soporte técnico en la nube porque no incluye Soporte técnico Signature Cloud: solo soporte técnico de Microsoft (local).

Es posible que vea el mensaje de error *"Este identificador de acceso ya está asociado a una cuenta. Póngase en contacto con el administrador técnico de cuentas para obtener un nuevo identificador de acceso".* **Este mensaje de error no es válido y debe omitirse.** Hemos solicitado que el error se deshabilite y se reemplazó por un mensaje de error de diagnóstico útil. 

Verá el valor anterior "Access ID is already associated..." (El identificador de acceso ya está asociado..." error si asocia un contrato de soporte técnico a una cuenta más de una vez al usar el Azure Portal. Consulte los escenarios siguientes:
...
*   [Servicios técnicos de preventa e implementación (TPD)](https://docs.microsoft.com/partner-center/technical-benefits)
