...
description: Obtenga información sobre cuándo escalar un problema de servicio al cliente a Microsoft y cómo presentar una vale de soporte técnico para diferentes tipos de servicios Microsoft.
author: Kim-Davis
ms.author: kimnich
...
Si el cliente tiene un problema de servicio que no se puede resolver y que cumple los criterios descritos en Escalar problemas a [Microsoft,](escalate-problems-to-microsoft.md)el proveedor indirecto puede presentar una vale de soporte técnico para ellos. Este proceso también es útil para escalar los problemas o conflictos de facturación y cuestiones de fraude.

## <a name="submit-a-service-request-for-a-customer"></a>Enviar una solicitud de servicio para un cliente

1. En el menú Centro de partners de CSP, seleccione **Clientes.**

2. En la página Clientes, seleccione o busque el cliente que desee.
    
3. En el menú del cliente, seleccione **Solicitudes de servicio.**

4. En el menú desplegable **Nueva solicitud**, selecciona **Azure** u **Office 365, Dynamics 365, Enterprise Mobility Suite**. Se le redirigirá al centro de administración Microsoft Azure Portal office 365.
...
>
>- Para que usted, como revendedor indirecto, cree solicitudes de servicio para el cliente en Azure, el proveedor indirecto debe concederle acceso a la cuenta de Azure del cliente. Esto es diferente de la administración en nombre de los clientes de Office 365.
>
...
Tiempos de respuesta **iniciales para incidentes técnicos de corrección de interrupción:**
...
Si inicia sesión directamente en el centro de administración de Office 365, lo ve en su propio contexto, no en el contexto de un cliente. Por eso solo debe iniciar sesión directamente en el Centro de administración de Office 365 al crear una solicitud de servicio para sus propias suscripciones.

### <a name="how-do-i-get-additional-dynamics-365-support"></a>¿Cómo puedo obtener soporte adicional de Dynamics 365?

Si tiene problemas relacionados con: suscripciones a planes de Dynamics 365, licencias, facturación, finance & Operations, licencias de productos de Dynamics 365 o necesita soporte técnico adicional:
