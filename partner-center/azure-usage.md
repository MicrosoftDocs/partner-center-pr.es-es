...
**Obtenga información mediante el uso de API de Azure de tamaño de máquina virtual**
...
**Obtenga información mediante el portal de Microsoft Azure de tamaño de máquina virtual**

1.  En el centro de partners, vaya a su **clientes** página.
...
**Obtenga información con Microsoft Azure PowerShell de tamaño de máquina virtual**
...
**Obtenga información mediante la API de Azure Resource Manager (ARM) de tamaño de máquina virtual**
