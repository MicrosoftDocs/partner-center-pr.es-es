...
---
# <a name="manage-licensing-in-marketplace-offers"></a>Administrar licencias en ofertas del marketplace
...
Antes de comenzar este proceso, debe familiarizarse con los aspectos básicos del marketplace comercial. Los artículos de la tabla siguiente le ayudarán a empezar a trabajar. 
...
6. Elija las opciones de licencia.
    ...
    - También puede permitir que los clientes ejecuten la funcionalidad base de la aplicación sin una licencia y que ejecuten características Premium una vez que han adquirido una licencia. Para ello, seleccione **Permitir que los clientes instalen mi aplicación aunque no se asignen licencias.**
...
El siguiente paso consiste en actualizar la solución mediante la adición de los ID de servicio para cada plan que acaba de copiar. Para obtener instrucciones al respecto, consulte [Creación de un paquete de AppSource para la solución.](/powerapps/developer/data-platform/create-package-app-appsource)
...
El procedimiento siguiente le guiará a través del proceso de hacer que su oferta se cree en AppSource. Para obtener más información sobre este proceso, vea [Introducción a las opciones de enumeración.](/azure/marketplace/determine-your-listing-type)
...
4. Filtre **por Ofertas enviadas,** seleccione la **pestaña** En curso y, a continuación, seleccione la oferta que quiera.
5. En la página de información general de esta oferta, seleccione **Administrar licencias.**
6. En la **ventana Administrar licencias,** seleccione el cliente en la **lista desplegable Detalles del** cliente. Si la relación con el cliente aún no existe, seleccione **+Invitar a un nuevo cliente para dar su consentimiento.**
7. Copie el vínculo que se muestra.
8. Envíe por correo electrónico este vínculo al administrador de facturación del cliente o al administrador global y haga que use este vínculo para acceder a admin.microsoft.com y aceptar y autorizar la relación que está estableciendo.
