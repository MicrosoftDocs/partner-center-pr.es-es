...
- Configuración de la cuenta de usuario de PSC
- Usuarios de conexión de ventas de asociados (PSC) 
...
Como sabe, su empresa perderá el acceso a PSC después del 31 de diciembre de 2020. Encontrará todo lo que desea hacer para administrar sus contratos y actuar sobre los acuerdos enviados por los vendedores de Microsoft en el centro de Partners. Sin embargo, habrá diferencias y las siguientes instrucciones le ayudarán a hacer que la transición al centro de Partners sea más suave y directa.
...
- Configure su cuenta con la ayuda del administrador de la [cuenta](https://docs.microsoft.com/partner-center/permissions-overview#manage-mpn-membership-and-your-company-non-aad-roles-these-roles-manage-the-company-business-rather-than-the-tenant)del centro de Partners.
- Lea este documento para obtener información sobre cómo vender en el centro de Partners.
- Configure las cuentas PSC Deal Manager y vendedor en el centro de Partners y asígneles el rol de [Administrador de referencias](https://docs.microsoft.com/partner-center/permissions-overview#manage-referrals) .
...
|Soluciones|Las soluciones que pertenecen a una sola lista de precios se pueden agregar a un contrato.|El asociado puede agregar [soluciones](https://docs.microsoft.com/partner-center/manage-co-sell-opportunities#add-solutions) que pertenezcan a las listas siguientes. a) sus propias soluciones b) soluciones de la venta conjunta de terceros (rol de Deal: transacción en PSC) y c) de otros socios de terceros (rol de negocio: ISV en PSC).|
...
Esta sección le ayudará a comprender la asignación exacta de atributos entre PSC y el centro de Partners. Cada pantalla de PSC se compara con la vista correspondiente en la sección oportunidades de venta conjunta del centro de Partners. 
...
### <a name="home-page-of-psc-and-default-view-of-the-co-sell-opportunities-in-partner-center"></a>Página principal de PSC y vista predeterminada de las oportunidades de venta conjunta en el centro de Partners
...
### <a name="psc-grid-view-and-the-partner-center-deal-view"></a>Vista de cuadrícula de PSC y vista de trato del centro de Partners
...
### <a name="deal-details-view-in-psc-and-partner-center"></a>Vista de detalles del contrato en PSC y en el centro de Partners
...
- La fecha estimada de cierre de la solución solo está disponible para los contratos de IOT OEM. No se muestra para ningún otro tipo de trato.
...
### <a name="psc-add-products-view-and-the-partner-center-add-solutions-view"></a>Vista de adición de productos de PSC y el centro de Partners agregar vista de soluciones
...
### <a name="user-management-in-psc-and-partner-center"></a>Administración de usuarios en PSC y centro de Partners
...
### <a name="user-role-assignment-in-psc-and-partner-center"></a>Asignación de roles de usuario en PSC y centro de Partners
...
- Todos los administradores de relaciones y vendedores de PSC deben tener asignado el rol de administrador de referencias.
...
### <a name="notifications-in-psc-and-partner-center"></a>Notificaciones en PSC y centro de Partners
...
### <a name="q-the-new-deal-button-is-greyed-out-for-our-account-what-should-i-do-to-start-creating-deals"></a>Q. El botón + nuevo contrato está atenuado para nuestra cuenta. ¿Qué debo hacer para empezar a crear negocios?
...
### <a name="q-can-i-assign-deals-to-a-specific-person-from-our-organization-like-psc"></a>Q. ¿Puedo asignar tratos a una persona específica de nuestra organización como PSC?
...
### <a name="q-is-there-a-view-of-all-the-deals-assigned-to-me"></a>Q. ¿Hay una vista de todas las ofertas asignadas a mí?
...
### <a name="q-is-there-a-read-only-view-for-the-deals"></a>Q. ¿Hay una vista de solo lectura para los acuerdos?
...
### <a name="q-how-can-i-register-a-deal-after-making-it-as-won"></a>Q. ¿Cómo puedo registrar un trato después de que lo gane?
...
### <a name="q-i-get-an-error-message-when-i-click-on-new-deal-registration-button-in-the-deal-registration-section-how-can-i-register-my-deals"></a>Q. Aparece un mensaje de error al hacer clic en el botón "+ registro del nuevo contrato" en la sección registro de trato. ¿Cómo puedo registrar mis negocios?
...
### <a name="q-is-adding-a-customer-organization-mandatory"></a>Q. ¿Es obligatorio agregar una organización de cliente?
...
### <a name="q-are-customer-contact-details-mandatory"></a>Q. ¿Son obligatorios los detalles de contacto del cliente?
...
### <a name="q-how-many-solutions-can-i-add-to-a-deal"></a>Q. ¿Cuántas soluciones se pueden agregar a un trato?

Puede Agregar hasta 50 soluciones (productos en PSC) a un trato. A diferencia de PSC, puede combinar soluciones de sus propias soluciones de venta conjunta coincidentes, SKU de Microsoft First Party y otras soluciones coincidentes de terceros. No hay ningún rol de trato que deba seleccionarse o estar disponible en el centro de Partners. En el caso de las SKU de Microsoft, puede agregar opcionalmente la cantidad y el precio de cada SKU que se agregue a la transacción.

### <a name="q-when-will-i-get-to-know-the-microsoft-seller-details-after-creating-a-deal"></a>Q. ¿Cuándo puedo conocer los detalles de los vendedores de Microsoft después de crear un trato?
...
### <a name="q-where-can-i-find-the-opportunity-id"></a>Q. ¿Dónde puedo encontrar el identificador de oportunidad?
...
### <a name="q-how-can-my-pdm-get-access-to-pc"></a>Q. ¿Cómo puede mi PDM obtener acceso al equipo?
...
- OCP Insights: si PDM solo está viendo los acuerdos & progreso relacionado con ellos, pueden usar el portal de OCP Insights para obtener la vista de la organización. Se trata de una herramienta interna que solo está disponible para PDM y los usuarios.
