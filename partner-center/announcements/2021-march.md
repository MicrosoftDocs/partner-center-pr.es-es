...
### <a name="summary"></a><span data-ttu-id="f7a87-109">Resumen</span><span class="sxs-lookup"><span data-stu-id="f7a87-109">Summary</span></span>
...
- <span data-ttu-id="f7a87-157">31 de marzo de 2020: Publicación original</span><span class="sxs-lookup"><span data-stu-id="f7a87-157">March 31, 2020: Original publication</span></span>
...
<span data-ttu-id="f7a87-171">Entre las ventajas del nuevo EAC se incluyen:</span><span class="sxs-lookup"><span data-stu-id="f7a87-171">Benefits of the new EAC include:</span></span>
...
### <a name="categories"></a><span data-ttu-id="f7a87-184">Categorías</span><span class="sxs-lookup"><span data-stu-id="f7a87-184">Categories</span></span>
...
### <a name="questions"></a><span data-ttu-id="f7a87-211">¿Tiene alguna pregunta?</span><span class="sxs-lookup"><span data-stu-id="f7a87-211">Questions?</span></span>
...
1. <span data-ttu-id="f7a87-225">El partner tiene una relación de factura directa con Microsoft (lo que significa que se trata de un partner de factura directa o de un proveedor indirecto).</span><span class="sxs-lookup"><span data-stu-id="f7a87-225">The partner has a direct billing relationship with Microsoft (which means that the partner is either a direct bill partner or an indirect provider).</span></span>
...
<span data-ttu-id="f7a87-243">Los partners que llevan a cabo actividades empresariales con clientes nuevos o existentes de los países siguientes ya se incorporaron con una versión anterior en noviembre de 2020.</span><span class="sxs-lookup"><span data-stu-id="f7a87-243">Partners who do business with new or existing customers in the following countries have already been onboarded with a previous release in November 2020.</span></span>
...
- <span data-ttu-id="f7a87-260">Asegúrese de enviar los datos adicionales al incorporar clientes nuevos o modificar los datos de clientes existentes.</span><span class="sxs-lookup"><span data-stu-id="f7a87-260">Make sure to submit the additional data when onboarding new customers or modifying existing customer details.</span></span>
...
### <a name="details"></a><span data-ttu-id="f7a87-272">Detalles</span><span class="sxs-lookup"><span data-stu-id="f7a87-272">Details</span></span>
...
### <a name="categories"></a><span data-ttu-id="f7a87-285">Categorías</span><span class="sxs-lookup"><span data-stu-id="f7a87-285">Categories</span></span>
...
- <span data-ttu-id="f7a87-310">Compra y administración:</span><span class="sxs-lookup"><span data-stu-id="f7a87-310">Purchase and Manage:</span></span>
  ...
  - <span data-ttu-id="f7a87-316">POST /customers/{customerId}/subscriptions/{subscriptionId}/transitions</span><span class="sxs-lookup"><span data-stu-id="f7a87-316">POST /customers/{customerId}/subscriptions/{subscriptionId}/transitions</span></span>
...
<span data-ttu-id="f7a87-400">Se han corregido los precios incorrectos de marzo de 2021 para Microsoft 365 F3 en libras (GBP) y euros (EUR).</span><span class="sxs-lookup"><span data-stu-id="f7a87-400">Incorrect March 2021 pricing has been corrected for Microsoft 365 F3 British Pound (GBP) and Euro (EUR).</span></span>
...
### <a name="questions"></a><span data-ttu-id="f7a87-423">¿Tiene alguna pregunta?</span><span class="sxs-lookup"><span data-stu-id="f7a87-423">Questions?</span></span>
...
<span data-ttu-id="f7a87-437">Para más información, consulte [Actualización del perfil legal de la empresa](../update-your-partner-profile.md#update-your-legal-business-profile).</span><span class="sxs-lookup"><span data-stu-id="f7a87-437">To learn more, see [Update your legal business profile](../update-your-partner-profile.md#update-your-legal-business-profile).</span></span>
...
### <a name="summary"></a><span data-ttu-id="f7a87-448">Resumen</span><span class="sxs-lookup"><span data-stu-id="f7a87-448">Summary</span></span>
...
- <span data-ttu-id="f7a87-464">Cambios en el programa Open License: revise los materiales de preparación sobre la [evolución del programa CSP y los cambios en el programa Open License](https://partner.microsoft.com/resources/collection/csp-open-evolution-to-a-better-experience#/).</span><span class="sxs-lookup"><span data-stu-id="f7a87-464">Open License program changes:  Review the [CSP program evolution and Open License program changes](https://partner.microsoft.com/resources/collection/csp-open-evolution-to-a-better-experience#/) readiness materials.</span></span> <span data-ttu-id="f7a87-465">Use este [mapa de preparación](https://partner.microsoft.com/resources/detail/csp-open-evolution-to-a-better-experience-readiness-map-pdf) para localizar rápidamente la información adecuada para su rol.</span><span class="sxs-lookup"><span data-stu-id="f7a87-465">Use this [readiness map](https://partner.microsoft.com/resources/detail/csp-open-evolution-to-a-better-experience-readiness-map-pdf) to quickly locate the right information for your role.</span></span>

### <a name="questions"></a><span data-ttu-id="f7a87-466">Preguntas</span><span class="sxs-lookup"><span data-stu-id="f7a87-466">Questions</span></span>

<span data-ttu-id="f7a87-467">Si tiene alguna pregunta, póngase en contacto con las comunidades de Yammer de CSP correspondientes.</span><span class="sxs-lookup"><span data-stu-id="f7a87-467">For any further questions please check your relevant CSP Yammer communities.</span></span>

_______________
## <a name="update-to-a-previous-announcement-premium-assessments-an-add-on-to-compliance-manager"></a><a name="7"></a><span data-ttu-id="f7a87-468">Actualización de un anuncio anterior: evaluaciones prémium, un complemento para el Administrador de cumplimiento</span><span class="sxs-lookup"><span data-stu-id="f7a87-468">Update to a previous announcement: Premium Assessments, an add-on to Compliance Manager</span></span>

### <a name="categories"></a><span data-ttu-id="f7a87-469">Categorías</span><span class="sxs-lookup"><span data-stu-id="f7a87-469">Categories</span></span>

- <span data-ttu-id="f7a87-470">Fecha: 15/03/2021</span><span class="sxs-lookup"><span data-stu-id="f7a87-470">Date: 2021-03-15</span></span>
- <span data-ttu-id="f7a87-471">Desarrollo de la empresa</span><span class="sxs-lookup"><span data-stu-id="f7a87-471">Grow your business</span></span>

### <a name="summary"></a><span data-ttu-id="f7a87-472">Resumen</span><span class="sxs-lookup"><span data-stu-id="f7a87-472">Summary</span></span>

<span data-ttu-id="f7a87-473">Las ofertas de prueba no deben aparecer en la lista de precios y se quitarán.</span><span class="sxs-lookup"><span data-stu-id="f7a87-473">The trial offers shouldn’t have been listed on the price list and will be removed.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="f7a87-474">Audiencia afectada</span><span class="sxs-lookup"><span data-stu-id="f7a87-474">Impacted audience</span></span>

<span data-ttu-id="f7a87-475">Todos los partners que realizan transacciones a través del Proveedor de soluciones en la nube (CSP).</span><span class="sxs-lookup"><span data-stu-id="f7a87-475">Partners transacting through Cloud Solution Provider</span></span>

### <a name="details"></a><span data-ttu-id="f7a87-476">Detalles</span><span class="sxs-lookup"><span data-stu-id="f7a87-476">Details</span></span>

<span data-ttu-id="f7a87-477">Las ofertas de prueba no se deberían haber incluido en la lista de precios.</span><span class="sxs-lookup"><span data-stu-id="f7a87-477">The trial offers shouldn’t have been included in the price list.</span></span> <span data-ttu-id="f7a87-478">Se quitarán de la lista de precios del 1 de mayo de 2021.</span><span class="sxs-lookup"><span data-stu-id="f7a87-478">These will be removed from the May 1, 2021 price list.</span></span>

<span data-ttu-id="f7a87-479">El anuncio original se encuentra [aquí](./2021-february.md#4).</span><span class="sxs-lookup"><span data-stu-id="f7a87-479">The original announcement is [here](./2021-february.md#4).</span></span>

### <a name="additional-resources"></a><span data-ttu-id="f7a87-480">Recursos adicionales</span><span class="sxs-lookup"><span data-stu-id="f7a87-480">Additional resources</span></span>

- [<span data-ttu-id="f7a87-481">Seguridad y cumplimiento de Microsoft 365 E5</span><span class="sxs-lookup"><span data-stu-id="f7a87-481">Microsoft 365 E5 security and compliance</span></span>](https://www.microsoft.com/licensing/product-licensing/microsoft-365-enterprise?activetab=m365-enterprise:primaryr5)

- [<span data-ttu-id="f7a87-482">Creación y administración de evaluaciones en el Administrador de cumplimiento de Microsoft: Cumplimiento de Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="f7a87-482">Build and manage assessments in Microsoft Compliance Manager - Microsoft 365 Compliance</span></span>](/microsoft-365/compliance/compliance-manager-assessments)

### <a name="next-steps"></a><span data-ttu-id="f7a87-483">Pasos siguientes</span><span class="sxs-lookup"><span data-stu-id="f7a87-483">Next steps</span></span>

<span data-ttu-id="f7a87-484">Revise los recursos sobre este tema y comparta esta información con las partes interesadas adecuadas de su organización.</span><span class="sxs-lookup"><span data-stu-id="f7a87-484">Review the resources about this topic, and share this information with the appropriate stakeholders in your organization.</span></span>

### <a name="questions"></a><span data-ttu-id="f7a87-485">¿Tiene alguna pregunta?</span><span class="sxs-lookup"><span data-stu-id="f7a87-485">Questions?</span></span>

<span data-ttu-id="f7a87-486">Si tiene preguntas sobre estas ofertas, consúltelas a las comunidades de Yammer correspondientes.</span><span class="sxs-lookup"><span data-stu-id="f7a87-486">For questions about these offers, check your relevant Yammer communities.</span></span>

________________
## <a name="migrate-your-solutions-from-one-commercial-partner-ocp-go-to-market-gtm-to-the-microsoft-commercial-marketplace"></a><a name="6"></a> <span data-ttu-id="f7a87-487">Migre sus soluciones de comercialización (GTM) de One Commercial Partner (OCP) al marketplace comercial de Microsoft</span><span class="sxs-lookup"><span data-stu-id="f7a87-487">Migrate your solutions from One Commercial Partner (OCP) go-to market (GTM) to the Microsoft commercial marketplace</span></span>

### <a name="categories"></a><span data-ttu-id="f7a87-488">Categorías</span><span class="sxs-lookup"><span data-stu-id="f7a87-488">Categories</span></span>

- <span data-ttu-id="f7a87-489">Fecha: 12/03/2021</span><span class="sxs-lookup"><span data-stu-id="f7a87-489">Date: 2021-03-12</span></span>
- <span data-ttu-id="f7a87-490">Funcionalidades</span><span class="sxs-lookup"><span data-stu-id="f7a87-490">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="f7a87-491">Resumen</span><span class="sxs-lookup"><span data-stu-id="f7a87-491">Summary</span></span>

<span data-ttu-id="f7a87-492">A partir del 29 de marzo de 2021, las funcionalidades de la herramienta de comercialización (GTM) de One Commercial Partner (OCP) se empezarán a ofrecer de forma limitada.</span><span class="sxs-lookup"><span data-stu-id="f7a87-492">From March 29, 2021, you will begin to experience limited One Commercial Partner (OCP) go-to market (GTM) capabilities.</span></span> <span data-ttu-id="f7a87-493">Le recomendamos que migre sus soluciones al marketplace comercial en el Centro de partners.</span><span class="sxs-lookup"><span data-stu-id="f7a87-493">We encourage you to migrate your solutions to the commercial marketplace in Partner Center.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="f7a87-494">Audiencia afectada</span><span class="sxs-lookup"><span data-stu-id="f7a87-494">Impacted audience</span></span>

<span data-ttu-id="f7a87-495">Organizaciones que venden de forma conjunta las soluciones de GTM de OCP</span><span class="sxs-lookup"><span data-stu-id="f7a87-495">Organizations co-selling with solutions in OCP GTM</span></span>

### <a name="details"></a><span data-ttu-id="f7a87-496">Detalles</span><span class="sxs-lookup"><span data-stu-id="f7a87-496">Details</span></span>

<span data-ttu-id="f7a87-497">En diciembre de 2020, iniciamos nuestra transición de la herramienta de GTM de OCP de Microsoft al marketplace comercial de Microsoft en el Centro de partners.</span><span class="sxs-lookup"><span data-stu-id="f7a87-497">In December 2020, we started our journey from the Microsoft OCP GTM tool to the Microsoft commercial marketplace in Partner Center.</span></span> <span data-ttu-id="f7a87-498">Este cambio amplía las funcionalidades del marketplace comercial, en el que puede presentar sus soluciones a millones de clientes, compartir de forma bidireccional las oportunidades con otros vendedores de Microsoft y partners y vender de manera conjunta soluciones innovadoras.</span><span class="sxs-lookup"><span data-stu-id="f7a87-498">This transition expands the capabilities of the commercial marketplace where you can showcase your solutions to millions of customers, bidirectionally share opportunities with other Microsoft and partner sellers, and jointly sell innovative solutions.</span></span>

<span data-ttu-id="f7a87-499">El siguiente hito de la transición tendrá lugar el 29 de marzo de 2021.</span><span class="sxs-lookup"><span data-stu-id="f7a87-499">The next milestone in the transition will take place on March 29, 2021.</span></span> <span data-ttu-id="f7a87-500">Será en ese momento cuando las funcionalidades de GTM de OCP se ofrecerán de manera limitada y algunos campos pasarán a ser de solo lectura.</span><span class="sxs-lookup"><span data-stu-id="f7a87-500">That’s when you’ll begin to experience limited OCP GTM capabilities, with some fields becoming read-only.</span></span> <span data-ttu-id="f7a87-501">Si actualmente vende de forma conjunta soluciones en la herramienta de GTM de OCP, le recomendamos que migre sus soluciones al marketplace comercial para aprovechar sus funcionalidades y simplificar la experiencia de publicación.</span><span class="sxs-lookup"><span data-stu-id="f7a87-501">If you’re currently co-selling with solutions in OCP GTM, we encourage you to migrate your solutions to the commercial marketplace to take advantage of its capabilities and simplify your publishing experience.</span></span> 

<span data-ttu-id="f7a87-502">Al cambiar al marketplace comercial, el Centro de partners se convertirá en el destino principal de la experiencia de publicación de venta conjunta.</span><span class="sxs-lookup"><span data-stu-id="f7a87-502">Moving to the commercial marketplace makes Partner Center the primary destination for the co-sell publishing experience.</span></span> <span data-ttu-id="f7a87-503">Desde allí podrá seguir desarrollando su empresa, ya que podrá conectar sus soluciones con nuestros clientes compartidos a través de los mismos canales y experiencias en el producto que usamos para los productos de Microsoft.</span><span class="sxs-lookup"><span data-stu-id="f7a87-503">It’s where you can continue to grow your business by connecting your solutions with our shared customers through the same channels and in-product experiences that we use for Microsoft products.</span></span> <span data-ttu-id="f7a87-504">[Obtenga información sobre el marketplace comercial](https://blogs.partner.microsoft.com/mpn/getting-started-with-the-microsoft-commercial-marketplace/).</span><span class="sxs-lookup"><span data-stu-id="f7a87-504">[Learn more about the commercial marketplace](https://blogs.partner.microsoft.com/mpn/getting-started-with-the-microsoft-commercial-marketplace/).</span></span>

### <a name="next-steps"></a><span data-ttu-id="f7a87-505">Pasos siguientes</span><span class="sxs-lookup"><span data-stu-id="f7a87-505">Next steps</span></span>

- <span data-ttu-id="f7a87-506">Si aún no ha trasladado sus soluciones, siga las instrucciones detalladas en la [guía de transición](/azure/marketplace/co-sell-solution-migration) o consulte el [tutorial detallado de vídeo](https://partner.microsoft.com/asset/detail/ocp-gtm-to-the-microsoft-commercial-marketplace-mp4) para completar todas las actividades de migración y empezar a publicar sus soluciones en el marketplace comercial.</span><span class="sxs-lookup"><span data-stu-id="f7a87-506">If you have not yet moved your solutions, follow the instructions detailed in the [transition guide](/azure/marketplace/co-sell-solution-migration) or view the [step-by-step video tutorial](https://partner.microsoft.com/asset/detail/ocp-gtm-to-the-microsoft-commercial-marketplace-mp4) to complete all migration activities and start publishing your solution(s) in the commercial marketplace.</span></span>

- <span data-ttu-id="f7a87-507">Si tiene preguntas sobre cómo será su experiencia con las funcionalidades limitadas de GTM de OCP, vea los [Requisitos de venta conjunta para publicar en las preguntas más frecuentes sobre el marketplace comercial de Microsoft](https://partner.microsoft.com/resources/detail/co-sell-requirements-publish-commercial-marketplace-faq-pdf).</span><span class="sxs-lookup"><span data-stu-id="f7a87-507">For questions regarding the limited capability experience in OCP GTM, view the [Co-sell requirements to publish in the Microsoft commercial marketplace FAQ](https://partner.microsoft.com/resources/detail/co-sell-requirements-publish-commercial-marketplace-faq-pdf).</span></span> <span data-ttu-id="f7a87-508">(Consulte la sección "Funcionalidades limitadas de GTM de OCP a partir del 29 de marzo de 2021").</span><span class="sxs-lookup"><span data-stu-id="f7a87-508">(See the section “OCP GTM limited capabilities starting March 29, 2021.”)</span></span>

### <a name="questions"></a><span data-ttu-id="f7a87-509">¿Tiene alguna pregunta?</span><span class="sxs-lookup"><span data-stu-id="f7a87-509">Questions?</span></span>

<span data-ttu-id="f7a87-510">Póngase en contacto con el [soporte técnico](https://partner.microsoft.com/support/?stage=1) si tiene alguna pregunta o necesita más información.</span><span class="sxs-lookup"><span data-stu-id="f7a87-510">Contact [Support](https://partner.microsoft.com/support/?stage=1) if you have any questions or need more information.</span></span>

________________
## <a name="expanding-the-new-commerce-experience-in-the-cloud-solution-provider-csp-program-for-azure-to-russia"></a><a name="5"></a><span data-ttu-id="f7a87-511">Expansión de la nueva experiencia comercial en el programa Proveedor de soluciones en la nube (CSP) de Azure a Rusia</span><span class="sxs-lookup"><span data-stu-id="f7a87-511">Expanding the new commerce experience in the Cloud Solution Provider (CSP) program for Azure to Russia</span></span>

### <a name="categories"></a><span data-ttu-id="f7a87-512">Categorías</span><span class="sxs-lookup"><span data-stu-id="f7a87-512">Categories</span></span>

- <span data-ttu-id="f7a87-513">Fecha: 10/03/2021</span><span class="sxs-lookup"><span data-stu-id="f7a87-513">Date: 2021-03-10</span></span>
- <span data-ttu-id="f7a87-514">Funcionalidades</span><span class="sxs-lookup"><span data-stu-id="f7a87-514">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="f7a87-515">Audiencia afectada</span><span class="sxs-lookup"><span data-stu-id="f7a87-515">Impacted audience</span></span>

<span data-ttu-id="f7a87-516">Todos los partners de Rusia que realizan transacciones a través del programa Proveedor de soluciones en la nube (CSP).</span><span class="sxs-lookup"><span data-stu-id="f7a87-516">All partners in Russia transacting through the Cloud Solution Provider (CSP) program.</span></span>

### <a name="details"></a><span data-ttu-id="f7a87-517">Detalles</span><span class="sxs-lookup"><span data-stu-id="f7a87-517">Details</span></span>

<span data-ttu-id="f7a87-518">Nos complace anunciar que la **nueva experiencia de comercio en CSP para Azure en Rusia** estará disponible a partir del 10 de marzo de 2021.</span><span class="sxs-lookup"><span data-stu-id="f7a87-518">Starting March 10 2021, we’re excited to announce the availability of the **new commerce experience in CSP for Azure in Russia**.</span></span> <span data-ttu-id="f7a87-519">Esta experiencia simplificará y mejorará la forma en que los clientes compran y consumen los servicios de Azure.</span><span class="sxs-lookup"><span data-stu-id="f7a87-519">This experience will streamline and improve the way customers buy and consume Azure services.</span></span> <span data-ttu-id="f7a87-520">También proporcionará a los partners del programa CSP una vista coherente de los precios de Azure a través de los movimientos de ventas, los precios de USD para la coherencia global, la concordancia de las fechas de facturación y el acceso a Azure Cost Management.</span><span class="sxs-lookup"><span data-stu-id="f7a87-520">It will also give partners in the CSP program a consistent view of Azure pricing across sales motions, USD pricing for global consistency, billing date alignment, and access to Azure Cost Management.</span></span>

### <a name="next-steps"></a><span data-ttu-id="f7a87-521">Pasos siguientes</span><span class="sxs-lookup"><span data-stu-id="f7a87-521">Next steps</span></span>

<span data-ttu-id="f7a87-522">Hay varios recursos disponibles que presentan la nueva experiencia de comercio de Azure y proporcionan información adicional.</span><span class="sxs-lookup"><span data-stu-id="f7a87-522">There are several resources available introducing the new Azure commerce experience and providing additional information.</span></span> <span data-ttu-id="f7a87-523">Busque las preguntas más frecuentes, los conjuntos de diapositivas, los vídeos, etc. más recientes en la [Galería de recursos de actualizaciones de programas de CSP](https://partner.microsoft.com/resources/collection/new-azure-experience-in-csp#/).</span><span class="sxs-lookup"><span data-stu-id="f7a87-523">Find the latest FAQs, decks, video and more in the [CSP Program Updates Resource Gallery](https://partner.microsoft.com/resources/collection/new-azure-experience-in-csp#/).</span></span>

________________
## <a name="partner-center-software-license-key-and-download-fulfillment"></a><a name="4"></a><span data-ttu-id="f7a87-524">Suministro de descargas y claves de licencia de software del Centro de partners</span><span class="sxs-lookup"><span data-stu-id="f7a87-524">Partner Center software license key and download fulfillment</span></span>

### <a name="categories"></a><span data-ttu-id="f7a87-525">Categorías</span><span class="sxs-lookup"><span data-stu-id="f7a87-525">Categories</span></span>

- <span data-ttu-id="f7a87-526">Fecha: 04/03/2021</span><span class="sxs-lookup"><span data-stu-id="f7a87-526">Date: 2021-03-04</span></span>
- <span data-ttu-id="f7a87-527">Funcionalidades</span><span class="sxs-lookup"><span data-stu-id="f7a87-527">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="f7a87-528">Resumen</span><span class="sxs-lookup"><span data-stu-id="f7a87-528">Summary</span></span>

<span data-ttu-id="f7a87-529">Se ha restablecido la funcionalidad de suministro de descargas y claves de licencia de software del Centro de partners.</span><span class="sxs-lookup"><span data-stu-id="f7a87-529">The Partner Center software download and license key fulfillment capability has been reinstated.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="f7a87-530">Audiencia afectada</span><span class="sxs-lookup"><span data-stu-id="f7a87-530">Impacted audience</span></span>

<span data-ttu-id="f7a87-531">Todos los partners que sean Proveedores de soluciones en la nube (CSP) que operen con pedidos de software de suscripción perpetua y de servidor a través del Centro de partners</span><span class="sxs-lookup"><span data-stu-id="f7a87-531">All Cloud Solution Provider (CSP) partners transacting perpetual and server subscription software orders through Partner Center</span></span>

### <a name="details"></a><span data-ttu-id="f7a87-532">Detalles</span><span class="sxs-lookup"><span data-stu-id="f7a87-532">Details</span></span>

<span data-ttu-id="f7a87-533">En respuesta a los comentarios de los partners, estamos restableciendo la funcionalidad de suministro del Centro de partners para obtener software y claves de licencia para los pedidos de software de suscripción perpetua y de servidor.</span><span class="sxs-lookup"><span data-stu-id="f7a87-533">In response to partner feedback, we’re reinstating the Partner Center fulfillment capability to obtain software and license keys for perpetual and server subscription software orders.</span></span> <span data-ttu-id="f7a87-534">Se restaurará a su estado previo antes de que se elimine el 19 de enero de 2021.</span><span class="sxs-lookup"><span data-stu-id="f7a87-534">It will be restored to its previous state prior to being removed on January 19, 2021.</span></span> <span data-ttu-id="f7a87-535">(Vea el [anuncio](2020-september.md#17)).</span><span class="sxs-lookup"><span data-stu-id="f7a87-535">(See the [announcement](2020-september.md#17).)</span></span>

<span data-ttu-id="f7a87-536">Tenga en cuenta que las claves de licencia de software y los vínculos de descarga son recursos de propiedad intelectual valiosos y muy solicitados.</span><span class="sxs-lookup"><span data-stu-id="f7a87-536">Note that software license keys and download links are valuable and highly sought-after intellectual property assets.</span></span> <span data-ttu-id="f7a87-537">Si se filtran, se pueden agotar rápidamente sus límites de activación, lo que puede provocar una experiencia negativa para clientes y partners.</span><span class="sxs-lookup"><span data-stu-id="f7a87-537">If leaked, they can quickly be depleted of their activation limits and cause a negative customer and partner experience.</span></span>

### <a name="next-steps"></a><span data-ttu-id="f7a87-538">Pasos siguientes</span><span class="sxs-lookup"><span data-stu-id="f7a87-538">Next steps</span></span>

<span data-ttu-id="f7a87-539">Revise los siguientes recursos para obtener instrucciones de uso e información importante sobre la distribución de las claves de software:</span><span class="sxs-lookup"><span data-stu-id="f7a87-539">Review the following resources for usage instructions and important guidance on software key distribution:</span></span>

- [<span data-ttu-id="f7a87-540">Venta de software local a través del programa CSP</span><span class="sxs-lookup"><span data-stu-id="f7a87-540">Sell on-premises software through the CSP program</span></span>](../csp-on-premise-software.md)
- <span data-ttu-id="f7a87-541">[Nueva guía de operaciones comerciales del Centro de partners](https://partner.microsoft.com/resources/detail/partner-center-new-commerce-operations-guide-pdf) (consulte la sección **Guía sobre la distribución de claves de software**).</span><span class="sxs-lookup"><span data-stu-id="f7a87-541">[Partner Center New Commerce Operations Guide](https://partner.microsoft.com/resources/detail/partner-center-new-commerce-operations-guide-pdf) (See the **Guidance on Software Key Distribution** section.)</span></span>

### <a name="questions"></a><span data-ttu-id="f7a87-542">¿Tiene alguna pregunta?</span><span class="sxs-lookup"><span data-stu-id="f7a87-542">Questions?</span></span>

<span data-ttu-id="f7a87-543">Si tiene alguna pregunta más sobre este aviso, consulte con las comunidades de Yammer correspondientes.</span><span class="sxs-lookup"><span data-stu-id="f7a87-543">If you have any further questions about this notice, check your relevant Yammer communities.</span></span>

________________
## <a name="migrate-your-deals-from-partner-sales-connect-psc-to-partner-center"></a><a name="3"></a><span data-ttu-id="f7a87-544">Migración de las ofertas de Partner Sales Connect (PSC) al Centro de partners</span><span class="sxs-lookup"><span data-stu-id="f7a87-544">Migrate your deals from Partner Sales Connect (PSC) to Partner Center</span></span>

### <a name="categories"></a><span data-ttu-id="f7a87-545">Categorías</span><span class="sxs-lookup"><span data-stu-id="f7a87-545">Categories</span></span>

- <span data-ttu-id="f7a87-546">Fecha: 04/03/2021</span><span class="sxs-lookup"><span data-stu-id="f7a87-546">Date: 2021-03-04</span></span>
- <span data-ttu-id="f7a87-547">Funcionalidades</span><span class="sxs-lookup"><span data-stu-id="f7a87-547">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="f7a87-548">Resumen</span><span class="sxs-lookup"><span data-stu-id="f7a87-548">Summary</span></span>

<span data-ttu-id="f7a87-549">Partner Sales Connect (PSC) se moverá a acceso de solo lectura a partir del 31 de marzo de 2021, por lo que le recomendamos que comience a migrar sus ofertas de PSC al Centro de partners.</span><span class="sxs-lookup"><span data-stu-id="f7a87-549">Partner Sales Connect (PSC) will move to read-only access starting March 31, 2021, so we urge you to begin migrating your deals from PSC to Partner Center.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="f7a87-550">Audiencia afectada</span><span class="sxs-lookup"><span data-stu-id="f7a87-550">Impacted audience</span></span>

<span data-ttu-id="f7a87-551">Partners con ofertas en PSC</span><span class="sxs-lookup"><span data-stu-id="f7a87-551">Partners with deals in PSC</span></span>

### <a name="details"></a><span data-ttu-id="f7a87-552">Detalles</span><span class="sxs-lookup"><span data-stu-id="f7a87-552">Details</span></span>

<span data-ttu-id="f7a87-553">Como parte de nuestro compromiso compartido con el crecimiento, la **venta conjunta con Microsoft** es el camino para que **le descubran, ofrezca sus conocimientos y amplíe su variedad de clientes** para obtener resultados positivos para estos.</span><span class="sxs-lookup"><span data-stu-id="f7a87-553">As part of our shared commitment to growth, **co-sell with Microsoft** is the path for you to **be discovered, deliver your expertise, and expand your customer footprint** for positive customer outcomes.</span></span> <span data-ttu-id="f7a87-554">Con una oferta media que es **3,5 veces más rápida** que la normal, la administración de la experiencia de venta conjunta en el Centro de partners le permite vender a través de los canales de cliente directo, partner y vendedor de Microsoft, y administrar toda la canalización de referencia en una sola ubicación.</span><span class="sxs-lookup"><span data-stu-id="f7a87-554">With an average deal that’s **3.5 times faster** than normal, managing your co-sell experience in Partner Center allows you to sell across the direct customer, partner, and Microsoft seller channels, and manage your entire referral pipeline in one location.</span></span>

<span data-ttu-id="f7a87-555">**PSC** pasará a **acceso de solo lectura** a partir del **31 de marzo de 2021**, por lo que le recomendamos que empiece el traslado al Centro de partners y acceda a estas mejoras en la funcionalidad:</span><span class="sxs-lookup"><span data-stu-id="f7a87-555">**PSC** will move to **read-only access** starting **March 31, 2021**, so we urge you to start your move to Partner Center and access these capability improvements:</span></span> 

- <span data-ttu-id="f7a87-556">**Enrutamiento más preciso** de las ofertas que comparte con Microsoft hacia el vendedor adecuado, en función del tipo de ayuda que necesite.</span><span class="sxs-lookup"><span data-stu-id="f7a87-556">**More accurate routing** of the deals that you share with Microsoft to the right seller, based on the type of assistance you need.</span></span>
- <span data-ttu-id="f7a87-557">**Validación de idoneidad de ofertas iniciales** para las soluciones aptas para incentivos y para cumplir los criterios del programa ISV Connect, al simplificar el proceso de aprobación y la atestación de prueba de ejecución (PoE) final.</span><span class="sxs-lookup"><span data-stu-id="f7a87-557">**Upfront deal eligibility validation** for incentive-eligible solutions and to meet the ISV Connect program criteria, simplifying the approval process and final proof of execution (POE) attestation.</span></span>
- <span data-ttu-id="f7a87-558">**Experiencia de usuario sin problemas** para administrar todas las oportunidades de venta conjunta y clientes potenciales cualificados para ventas en un solo lugar.</span><span class="sxs-lookup"><span data-stu-id="f7a87-558">**Seamless user experience** to manage all your co-sell opportunities and sales qualified leads in one place.</span></span>

<span data-ttu-id="f7a87-559">Además, recientemente hemos agregado nuevas características al Centro de partners para ayudarle en el traslado:</span><span class="sxs-lookup"><span data-stu-id="f7a87-559">We’ve also recently added new features in Partner Center to assist in your move:</span></span>

- [<span data-ttu-id="f7a87-560">Operaciones masivas para las oportunidades de venta conjunta</span><span class="sxs-lookup"><span data-stu-id="f7a87-560">Bulk operations for co-sell opportunities</span></span>](../bulk-operations.md)
- <span data-ttu-id="f7a87-561">[Característica de migración de ofertas](../psc-to-pc.md) (consulte la sección **Migración de contratos de PSC**).</span><span class="sxs-lookup"><span data-stu-id="f7a87-561">[Deal migration feature](../psc-to-pc.md) (See the **PSC Deals migration** section.)</span></span>

<span data-ttu-id="f7a87-562">Con la experiencia de venta conjunta en el Centro de partners, los equipos de ventas tendrán más tiempo para centrarse en fomentar la captación de clientes potenciales y oportunidades, cerrar acuerdos y crear relaciones duraderas con los clientes.</span><span class="sxs-lookup"><span data-stu-id="f7a87-562">Using the co-sell experience in Partner Center, your sales teams will have more time to focus on nurturing leads and opportunities, closing deals, and creating lasting customer relationships.</span></span>

### <a name="next-steps"></a><span data-ttu-id="f7a87-563">Pasos siguientes</span><span class="sxs-lookup"><span data-stu-id="f7a87-563">Next steps</span></span>

<span data-ttu-id="f7a87-564">Use la [guía de transición](../psc-to-pc.md) del Centro de partners para conocer por los pasos necesarios para migrar sus ofertas de PSC al Centro de partners.</span><span class="sxs-lookup"><span data-stu-id="f7a87-564">Use the Partner Center [transition guide](../psc-to-pc.md) to walk you through the steps to migrate your deals from PSC to Partner Center.</span></span>

### <a name="questions"></a><span data-ttu-id="f7a87-565">¿Tiene alguna pregunta?</span><span class="sxs-lookup"><span data-stu-id="f7a87-565">Questions?</span></span>

<span data-ttu-id="f7a87-566">Si tiene más preguntas, póngase en contacto con [Soporte técnico](https://partner.microsoft.com/support/?stage=1).</span><span class="sxs-lookup"><span data-stu-id="f7a87-566">For any further questions, contact [Support](https://partner.microsoft.com/support/?stage=1).</span></span>

________________
## <a name="new-microsoft-dynamics-365-products-and-offers-available-on-april-1-2021"></a><a name="2"></a><span data-ttu-id="f7a87-567">Nuevos productos y ofertas de Microsoft Dynamics 365 disponibles el 1 de abril de 2021</span><span class="sxs-lookup"><span data-stu-id="f7a87-567">New Microsoft Dynamics 365 products and offers available on April 1, 2021</span></span>

### <a name="categories"></a><span data-ttu-id="f7a87-568">Categorías</span><span class="sxs-lookup"><span data-stu-id="f7a87-568">Categories</span></span>

- <span data-ttu-id="f7a87-569">Fecha: 04/03/2021</span><span class="sxs-lookup"><span data-stu-id="f7a87-569">Date: 2021-03-04</span></span>
- <span data-ttu-id="f7a87-570">Funcionalidades</span><span class="sxs-lookup"><span data-stu-id="f7a87-570">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="f7a87-571">Resumen</span><span class="sxs-lookup"><span data-stu-id="f7a87-571">Summary</span></span>

<span data-ttu-id="f7a87-572">El 1 de abril de 2021, Microsoft lanzará varios productos y ofertas nuevos para el programa Proveedor de soluciones en la nube (CSP).</span><span class="sxs-lookup"><span data-stu-id="f7a87-572">On April 1, 2021, Microsoft will be launching several new products and offers for the Cloud Solution Provider (CSP) program.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="f7a87-573">Audiencia afectada</span><span class="sxs-lookup"><span data-stu-id="f7a87-573">Impacted audience</span></span>

<span data-ttu-id="f7a87-574">Todos los partners que operan a través del programa Proveedor de soluciones en la nube (CSP)</span><span class="sxs-lookup"><span data-stu-id="f7a87-574">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="f7a87-575">Detalles</span><span class="sxs-lookup"><span data-stu-id="f7a87-575">Details</span></span>

<span data-ttu-id="f7a87-576">El 1 de abril de 2021, Microsoft lanzará los siguientes nuevos productos y ofertas:</span><span class="sxs-lookup"><span data-stu-id="f7a87-576">On April 1, 2021, Microsoft will be launching the following new products and offers:</span></span>

- <span data-ttu-id="f7a87-577">Power BI Premium por usuario</span><span class="sxs-lookup"><span data-stu-id="f7a87-577">Power BI Premium Per User</span></span>
- <span data-ttu-id="f7a87-578">Expansión geográfica y por segmento de USL de Customer Voice y Marketing</span><span class="sxs-lookup"><span data-stu-id="f7a87-578">Customer Voice and Marketing USL geo and segment expansion</span></span>

<span data-ttu-id="f7a87-579">**Power BI Premium por usuario**</span><span class="sxs-lookup"><span data-stu-id="f7a87-579">**Power BI Premium Per User**</span></span>

<span data-ttu-id="f7a87-580">Microsoft presentará las primeras ofertas de Power BI Premium por usuario.</span><span class="sxs-lookup"><span data-stu-id="f7a87-580">Microsoft will introduce the first per-user Power BI Premium offers.</span></span> <span data-ttu-id="f7a87-581">Actualmente, Power BI Premium se vende solo en una construcción de capacidad.</span><span class="sxs-lookup"><span data-stu-id="f7a87-581">Power BI Premium is currently sold only in a capacity construct.</span></span> <span data-ttu-id="f7a87-582">Power BI Premium por usuario proporciona acceso a las funcionalidades empresariales de business intelligence (BI) y análisis.</span><span class="sxs-lookup"><span data-stu-id="f7a87-582">Power BI Premium Per User provides access to enterprise business intelligence (BI) and analytics capabilities.</span></span> <span data-ttu-id="f7a87-583">Su oferta de licencias flexible e individual por puesto está dirigida a pequeñas y medianas empresas.</span><span class="sxs-lookup"><span data-stu-id="f7a87-583">Its flexible individual seat licensing caters to small and medium-sized businesses.</span></span>

<span data-ttu-id="f7a87-584">Revise los [detalles de la versión de Power BI](/power-platform-release-plan/2020wave2/power-bi/planned-features) para obtener más información sobre esta oferta.</span><span class="sxs-lookup"><span data-stu-id="f7a87-584">Review the [Power BI release details](/power-platform-release-plan/2020wave2/power-bi/planned-features) to learn more about this offer.</span></span>


<span data-ttu-id="f7a87-585">**Detalles de la oferta**</span><span class="sxs-lookup"><span data-stu-id="f7a87-585">**Offer details**</span></span>

<span data-ttu-id="f7a87-586">Tenga en cuenta que el nombre de la oferta difiere ligeramente de la vista previa de la lista de precios.</span><span class="sxs-lookup"><span data-stu-id="f7a87-586">Note that the offer name differs slightly from the price list preview.</span></span>

| <span data-ttu-id="f7a87-587">Nombre de la oferta</span><span class="sxs-lookup"><span data-stu-id="f7a87-587">Offer name</span></span> | <span data-ttu-id="f7a87-588">Id. de oferta</span><span class="sxs-lookup"><span data-stu-id="f7a87-588">Offer ID</span></span> |
| ------ |----------- |
| <span data-ttu-id="f7a87-589">Power BI Premium por usuario</span><span class="sxs-lookup"><span data-stu-id="f7a87-589">Power BI Premium Per User</span></span> | <span data-ttu-id="f7a87-590">9c810018-9356-4903-95ab-eeb956289290</span><span class="sxs-lookup"><span data-stu-id="f7a87-590">9c810018-9356-4903-95ab-eeb956289290</span></span> | 
| <span data-ttu-id="f7a87-591">Power BI Premium por usuario para profesores</span><span class="sxs-lookup"><span data-stu-id="f7a87-591">Power BI Premium Per User for Faculty</span></span> | <span data-ttu-id="f7a87-592">3affc44f-f372-4ad5-8657-aadd9574fce0</span><span class="sxs-lookup"><span data-stu-id="f7a87-592">3affc44f-f372-4ad5-8657-aadd9574fce0</span></span> | 
| <span data-ttu-id="f7a87-593">Power BI Premium por usuario para estudiantes</span><span class="sxs-lookup"><span data-stu-id="f7a87-593">Power BI Premium Per User for Students</span></span> | <span data-ttu-id="f7a87-594">657eea87-d0b0-4c89-8c8e-9b04395bd940</span><span class="sxs-lookup"><span data-stu-id="f7a87-594">657eea87-d0b0-4c89-8c8e-9b04395bd940</span></span> | 
| <span data-ttu-id="f7a87-595">Power BI Premium por usuario (precios para personal de ONG)</span><span class="sxs-lookup"><span data-stu-id="f7a87-595">Power BI Premium Per User (Nonprofit Staff Pricing)</span></span> | <span data-ttu-id="f7a87-596">7a0a856c-059f-45dd-9d26-ae27992e706a</span><span class="sxs-lookup"><span data-stu-id="f7a87-596">7a0a856c-059f-45dd-9d26-ae27992e706a</span></span> | 
| <span data-ttu-id="f7a87-597">Complemento de Power BI Premium por usuario</span><span class="sxs-lookup"><span data-stu-id="f7a87-597">Power BI Premium Per User Add-On</span></span> | <span data-ttu-id="f7a87-598">244ff87e-5925-44a0-bf31-cea189719b58</span><span class="sxs-lookup"><span data-stu-id="f7a87-598">244ff87e-5925-44a0-bf31-cea189719b58</span></span> | 
| <span data-ttu-id="f7a87-599">Complemento de Power BI Premium por usuario para profesores</span><span class="sxs-lookup"><span data-stu-id="f7a87-599">Power BI Premium Per User Add-On for Faculty</span></span> | <span data-ttu-id="f7a87-600">5da849bd-b8f7-4340-b4f4-3a9eaeb8987e</span><span class="sxs-lookup"><span data-stu-id="f7a87-600">5da849bd-b8f7-4340-b4f4-3a9eaeb8987e</span></span> | 
| <span data-ttu-id="f7a87-601">Complemento de Power BI Premium por usuario para estudiantes</span><span class="sxs-lookup"><span data-stu-id="f7a87-601">Power BI Premium Per User Add-On for Students</span></span> | <span data-ttu-id="f7a87-602">cf62d70d-5af5-422a-bda8-97936402ac8e</span><span class="sxs-lookup"><span data-stu-id="f7a87-602">cf62d70d-5af5-422a-bda8-97936402ac8e</span></span> | 
| <span data-ttu-id="f7a87-603">Complemento Power BI Premium por usuario (precios para personal de ONG)</span><span class="sxs-lookup"><span data-stu-id="f7a87-603">Power BI Premium Per User Add-On (Nonprofit Staff Pricing)</span></span> | <span data-ttu-id="f7a87-604">31c03289-47ab-4ab0-8df1-03742c127ac6</span><span class="sxs-lookup"><span data-stu-id="f7a87-604">31c03289-47ab-4ab0-8df1-03742c127ac6</span></span> | 

<span data-ttu-id="f7a87-605">**Expansión geográfica y por segmento de USL de Customer Voice y Marketing**</span><span class="sxs-lookup"><span data-stu-id="f7a87-605">**Customer Voice and Marketing USL geo and segment expansion**</span></span>

<span data-ttu-id="f7a87-606">Como seguimiento del lanzamiento de diciembre de 2020, se han cambiado las ofertas de USL de Dynamics 365 Customer Voice y Marketing para agregar nuevos países y más SKU de educación y ONG.</span><span class="sxs-lookup"><span data-stu-id="f7a87-606">As a follow-up to the December 2020 launch, Dynamics 365 Customer Voice and Marketing USL offers have been changed to add new countries and more nonprofit and educational SKUs.</span></span>

| <span data-ttu-id="f7a87-607">Nombre de la oferta</span><span class="sxs-lookup"><span data-stu-id="f7a87-607">Offer name</span></span> | <span data-ttu-id="f7a87-608">Id. de oferta</span><span class="sxs-lookup"><span data-stu-id="f7a87-608">Offer ID</span></span> |
| ------ |----------- |
| <span data-ttu-id="f7a87-609">USL de Dynamics 365 Customer Voice (precios para personal de ONG)</span><span class="sxs-lookup"><span data-stu-id="f7a87-609">Dynamics 365 Customer Voice USL (Nonprofit Staff Pricing)</span></span> | <span data-ttu-id="f7a87-610">7a8642a5-481e-4906-a642-b56dbeeb62a0</span><span class="sxs-lookup"><span data-stu-id="f7a87-610">7a8642a5-481e-4906-a642-b56dbeeb62a0</span></span> |
| <span data-ttu-id="f7a87-611">USL de Dynamics 365 Customer Voice para profesores</span><span class="sxs-lookup"><span data-stu-id="f7a87-611">Dynamics 365 Customer Voice USL for Faculty</span></span> | <span data-ttu-id="f7a87-612">85162d70-9676-4cf6-a4bc-a0d6672f2657</span><span class="sxs-lookup"><span data-stu-id="f7a87-612">85162d70-9676-4cf6-a4bc-a0d6672f2657</span></span> |

<span data-ttu-id="f7a87-613">Para obtener más información sobre estas ofertas, visite las páginas siguientes:</span><span class="sxs-lookup"><span data-stu-id="f7a87-613">Visit the following pages to find out more about these offers:</span></span>

- [<span data-ttu-id="f7a87-614">Página principal de Dynamics 365 Customer Voice</span><span class="sxs-lookup"><span data-stu-id="f7a87-614">Dynamics 365 Customer Service Voice home page</span></span>](https://dynamics.microsoft.com/customer-voice/overview/)
- [<span data-ttu-id="f7a87-615">Página principal de Dynamics 365 Marketing</span><span class="sxs-lookup"><span data-stu-id="f7a87-615">Dynamics 365 Marketing home page</span></span>](https://dynamics.microsoft.com/customer-voice/overview/)

### <a name="next-steps"></a><span data-ttu-id="f7a87-616">Pasos siguientes</span><span class="sxs-lookup"><span data-stu-id="f7a87-616">Next steps</span></span>

<span data-ttu-id="f7a87-617">Revise los recursos sobre este tema y comparta esta información con las partes interesadas adecuadas de su organización.</span><span class="sxs-lookup"><span data-stu-id="f7a87-617">Review the resources on this topic, and share this information with the appropriate stakeholders in your organization.</span></span>  

### <a name="questions"></a><span data-ttu-id="f7a87-618">¿Tiene alguna pregunta?</span><span class="sxs-lookup"><span data-stu-id="f7a87-618">Questions?</span></span>

<span data-ttu-id="f7a87-619">Si tiene preguntas sobre estas ofertas, consulte a las comunidades de Yammer correspondientes.</span><span class="sxs-lookup"><span data-stu-id="f7a87-619">For any questions about these offers, check your relevant Yammer communities.</span></span> 

________________
## <a name="microsoft-universal-print-now-available-in-some-suites"></a><a name="1"></a> <span data-ttu-id="f7a87-620">Impresión universal de Microsoft ahora está disponible en algunos conjuntos de aplicaciones</span><span class="sxs-lookup"><span data-stu-id="f7a87-620">Microsoft Universal Print now available in some suites</span></span>

### <a name="categories"></a><span data-ttu-id="f7a87-621">Categorías</span><span class="sxs-lookup"><span data-stu-id="f7a87-621">Categories</span></span>

- <span data-ttu-id="f7a87-622">Fecha: 31/03/2021</span><span class="sxs-lookup"><span data-stu-id="f7a87-622">Date: 2021-03-33</span></span>
- <span data-ttu-id="f7a87-623">Funcionalidades</span><span class="sxs-lookup"><span data-stu-id="f7a87-623">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="f7a87-624">Resumen</span><span class="sxs-lookup"><span data-stu-id="f7a87-624">Summary</span></span>

<span data-ttu-id="f7a87-625">Impresión universal de Microsoft estará disponible para operaciones dentro de ciertos conjuntos de aplicaciones de Microsoft 365 y como complemento independiente a partir del 1 de marzo de 2021.</span><span class="sxs-lookup"><span data-stu-id="f7a87-625">Microsoft Universal Print will be available to transact within select Microsoft 365 suites and as a standalone add-on from March 1, 2021.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="f7a87-626">Audiencia afectada</span><span class="sxs-lookup"><span data-stu-id="f7a87-626">Impacted audience</span></span>

<span data-ttu-id="f7a87-627">Todos los partners que operan a través del programa Proveedor de soluciones en la nube (CSP)</span><span class="sxs-lookup"><span data-stu-id="f7a87-627">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="f7a87-628">Detalles</span><span class="sxs-lookup"><span data-stu-id="f7a87-628">Details</span></span>

<span data-ttu-id="f7a87-629">[Impresión universal](https://aka.ms/universalprint) es un servicio de impresión de Microsoft 365 que elimina la necesidad de servidores de impresión locales, y permite que los dispositivos Windows impriman en impresoras registradas en Azure.</span><span class="sxs-lookup"><span data-stu-id="f7a87-629">[Universal Print](https://aka.ms/universalprint) is a Microsoft 365 print service that removes the need for on-premises print servers, and enables Windows devices to print to Azure-registered printers.</span></span> <span data-ttu-id="f7a87-630">Estará disponible para operar desde el 1 de marzo de 2021.</span><span class="sxs-lookup"><span data-stu-id="f7a87-630">It will be available to transact from March 1, 2021.</span></span>

<span data-ttu-id="f7a87-631">Los trabajadores se benefician de una impresión sin controladores, una detección de impresoras basada en ubicaciones y una experiencia de impresión intuitiva sin curva de aprendizaje.</span><span class="sxs-lookup"><span data-stu-id="f7a87-631">Workers benefit from driverless printing, streamlined location-based printer discovery, and an intuitive printing experience with no learning curve.</span></span> <span data-ttu-id="f7a87-632">Los dispositivos que están unidos a Azure Active Directory (Azure AD) usan credenciales de Azure AD existentes para imprimir de forma segura.</span><span class="sxs-lookup"><span data-stu-id="f7a87-632">Devices that are joined to Azure Active Directory (Azure AD) use existing Azure AD credentials to print securely.</span></span> <span data-ttu-id="f7a87-633">Los administradores administran la impresión mediante Azure Portal y pueden conectar fácilmente las impresoras con la compatibilidad nativa con Impresión universal.</span><span class="sxs-lookup"><span data-stu-id="f7a87-633">Administrators manage printing by using the Azure portal, and can easily connect printers with native support for Universal Print.</span></span> <span data-ttu-id="f7a87-634">Impresión universal se puede implementar con impresoras no compatibles mediante el software del conector de Impresión universal.</span><span class="sxs-lookup"><span data-stu-id="f7a87-634">Universal Print can be deployed with non-compatible printers by using Universal Print connector software.</span></span>

<span data-ttu-id="f7a87-635">Impresión universal se incluirá en un comienzo en Windows E3, A3, E5 y A5, y Microsoft 365 BP, F3, E3, A3, E5 y A5.</span><span class="sxs-lookup"><span data-stu-id="f7a87-635">Universal Print will be backfilled at launch to Windows E3, A3, E5, and A5, and Microsoft 365 BP, F3, E3, A3, E5, and A5.</span></span>  

<span data-ttu-id="f7a87-636">**Detalles de la oferta**</span><span class="sxs-lookup"><span data-stu-id="f7a87-636">**Offer details**</span></span>

<span data-ttu-id="f7a87-637">Tenga en cuenta que el nombre de la oferta difiere ligeramente de la vista previa de la lista de precios.</span><span class="sxs-lookup"><span data-stu-id="f7a87-637">Note that the offer name differs slightly from the price list preview.</span></span>

| <span data-ttu-id="f7a87-638">Nombre de la oferta</span><span class="sxs-lookup"><span data-stu-id="f7a87-638">Offer name</span></span> | <span data-ttu-id="f7a87-639">Id. de oferta</span><span class="sxs-lookup"><span data-stu-id="f7a87-639">Offer ID</span></span> | <span data-ttu-id="f7a87-640">Id. de material</span><span class="sxs-lookup"><span data-stu-id="f7a87-640">Material ID</span></span> |
| ------ |----------- |----------- |  
| <span data-ttu-id="f7a87-641">Complemento de volumen de Impresión universal (500 trabajos): Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="f7a87-641">Universal Print volume add-on (500 jobs) - Microsoft 365</span></span>  | <span data-ttu-id="f7a87-642">cb131356-45ee-4ae2-8537-873b706c8e75</span><span class="sxs-lookup"><span data-stu-id="f7a87-642">cb131356-45ee-4ae2-8537-873b706c8e75</span></span>     | <span data-ttu-id="f7a87-643">9BI-00004</span><span class="sxs-lookup"><span data-stu-id="f7a87-643">9BI-00004</span></span>   |
| <span data-ttu-id="f7a87-644">Complemento de volumen de Impresión universal (500 trabajos) para profesores: Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="f7a87-644">Universal Print volume add-on (500 jobs) for faculty - Microsoft 365</span></span>   | <span data-ttu-id="f7a87-645">477bee81-9872-43d6-91d3-c72390bfcf49</span><span class="sxs-lookup"><span data-stu-id="f7a87-645">477bee81-9872-43d6-91d3-c72390bfcf49</span></span>   | <span data-ttu-id="f7a87-646">9BK-00004</span><span class="sxs-lookup"><span data-stu-id="f7a87-646">9BK-00004</span></span>   |
| <span data-ttu-id="f7a87-647">Complemento de volumen de Impresión universal (500 trabajos): Windows</span><span class="sxs-lookup"><span data-stu-id="f7a87-647">Universal Print volume add-on (500 jobs) - Windows</span></span>    | <span data-ttu-id="f7a87-648">d3ddc493-5741-4e0d-a02d-07edbb0bb72e</span><span class="sxs-lookup"><span data-stu-id="f7a87-648">d3ddc493-5741-4e0d-a02d-07edbb0bb72e</span></span>   | <span data-ttu-id="f7a87-649">9BI-00002</span><span class="sxs-lookup"><span data-stu-id="f7a87-649">9BI-00002</span></span>   |
| <span data-ttu-id="f7a87-650">Complemento de volumen de Impresión universal (500 trabajos) para profesores: Windows</span><span class="sxs-lookup"><span data-stu-id="f7a87-650">Universal Print volume add-on (500 jobs) for faculty - Windows</span></span>   |  <span data-ttu-id="f7a87-651">d0862f05-80f5-4fd4-8432-fe72dd893cc7</span><span class="sxs-lookup"><span data-stu-id="f7a87-651">d0862f05-80f5-4fd4-8432-fe72dd893cc7</span></span>  | <span data-ttu-id="f7a87-652">9BK-00002</span><span class="sxs-lookup"><span data-stu-id="f7a87-652">9BK-00002</span></span>   |

### <a name="next-steps"></a><span data-ttu-id="f7a87-653">Pasos siguientes</span><span class="sxs-lookup"><span data-stu-id="f7a87-653">Next steps</span></span>

<span data-ttu-id="f7a87-654">Familiarícese con la lista de precios y la [Introducción a Impresión universal](/universal-print/fundamentals/universal-print-whatis).</span><span class="sxs-lookup"><span data-stu-id="f7a87-654">Familiarize yourself with the price list and the [Universal Print overview](/universal-print/fundamentals/universal-print-whatis).</span></span> <span data-ttu-id="f7a87-655">Comparta esta información con todos los contactos de su organización a quienes corresponda.</span><span class="sxs-lookup"><span data-stu-id="f7a87-655">Share this information with all appropriate contacts in your organization.</span></span>

### <a name="questions"></a><span data-ttu-id="f7a87-656">¿Alguna pregunta?</span><span class="sxs-lookup"><span data-stu-id="f7a87-656">Questions?</span></span>

<span data-ttu-id="f7a87-657">Si tiene preguntas sobre estas ofertas, consulte a las comunidades de Yammer correspondientes.</span><span class="sxs-lookup"><span data-stu-id="f7a87-657">For any questions about these offers, check your relevant Yammer communities.</span></span>
