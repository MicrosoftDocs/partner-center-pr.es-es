...
## <a name="phase-1-now-live-euefta--uk-change-of-partner-billing-currency-for-new-commerce-offers"></a><a name="15"></a> Fase 1 ya disponible: Cambio en EU/EFTA y Reino Unido de la moneda de facturación de partners para nuevas ofertas comerciales
...
- Todos los partners que realizan transacciones mediante el programa Proveedor de soluciones en la nube en la región EU/EFTA y Reino Unido
...
Después de la fase 2, se facturará a los partners de la región de UE/AELC y el Reino Unido en la moneda de la ubicación del partner para todos los clientes y todas las compras del programa CSP.
...
Esta actualización reducirá la complejidad y la sobrecarga por la facturación en varias monedas en la región de la UE/AELC y el Reino Unido para la nueva experiencia comercial.
...
- 28 de enero de 2021: 
    -    Anuncio de que la fase 1 está activa 
    -    Se aclara que, aunque el Reino Unido no está incluido en la UE/AELC, forma parte de [la región y el mercado europeos de Microsoft](../regional-authorization-overview.md) y se verá afectado.


________________
## <a name="changes-to-the-cloud-solution-provider-csp-customer-onboarding-requirements"></a><a name="14"></a> Cambios en los requisitos de incorporación de clientes de Proveedor de soluciones en la nube (CSP)
...
________________
## <a name="microsoft-partner-agreement-mpa--indirect-reseller-update--new-faqs"></a><a name="13"></a> Preguntas más frecuentes nuevas y actualizadas sobre Microsoft Partner Agreement (MPA): revendedores indirectos 
...
Todos los proveedores y revendedores indirectos que realizan transacciones mediante el programa Proveedor de soluciones en la nube (CSP).

### <a name="details"></a>Detalles

La implementación del contrato Microsoft Partner Agreement (MPA) para revendedores indirectos está actualmente en curso. Para admitir más proveedores y revendedores, hemos escuchado sus comentarios y hemos consolidado consultas comunes sobre cómo aceptar el MPA en una nueva [página de preguntas más frecuentes](../mpa-indirect-provider-faq.md).

### <a name="next-steps"></a>Pasos siguientes

**Revendedores indirectos:** Si no ha aceptado el contrato MPA, revise las [preguntas más frecuentes sobre el MPA](../mpa-indirect-provider-faq.md) y siga las instrucciones paso a paso disponibles [aquí](../microsoft-partner-agreement.md) para aceptarlo.

**Proveedores indirectos:** Póngase en contacto con sus revendedores indirectos y ayúdeles a usar las [Preguntas más frecuentes sobre MPA](../mpa-indirect-provider-faq.md) y las instrucciones paso a paso disponibles [aquí](../microsoft-partner-agreement.md).

### <a name="questions"></a>¿Tiene alguna pregunta?

Si tiene alguna pregunta relacionada con esta notificación, póngase en contacto con el [soporte técnico del Centro de partners](https://partner.microsoft.com/support/v2/?stage=2&topicid=2da4e1c7-3b4b-5672-6227-56bc75a936b4)

________________
## <a name="partner-center-audit-log-changes-to-include-two-new-operation-types-for-dap"></a><a name="12"></a> El registro de auditoría del Centro de partners ha cambiado para incluir dos nuevos tipos de operación para DAP
...
- [Obtención de un registro de la actividad del Centro de partners: desarrollador de aplicaciones del Centro de partners | Microsoft Docs](/partner-center/develop/get-a-record-of-partner-center-activity-by-user)
- [Recursos de auditoría: desarrollador de aplicaciones del Centro de partners | Microsoft Docs](/partner-center/develop/auditing-resources)
...
________________
## <a name="changes-to-azure-offer-availability-in-csp-related-to-the-new-commerce-experience-in-csp-for-azure"></a><a name="11"></a> Cambios en la disponibilidad de la oferta de Azure en CSP relacionados con la nueva experiencia comercial en CSP para Azure
...
- [Créditos obtenidos por los partners. Información general: Centro de partners | Microsoft Docs](../partner-earned-credit.md?branch=main)
- [Créditos obtenidos por los partners para servicios administrados: Centro de partners | Microsoft Docs](../partner-earned-credit-explanation.md?branch=main)
- [Roles y permisos para los créditos obtenidos por los partners: Centro de partners | Microsoft Docs](../azure-roles-perms-pec.md)
...
________________
## <a name="perpetual-software-now-generally-available-for-the-cloud-solution-provider-program"></a><a name="10"></a> Software perpetuo ahora disponible con carácter general para el programa Proveedor de soluciones en la nube
...
- 19 de enero de 2021: fecha de publicación original 
...
_____________
## <a name="reminder-introducingapithrottlingtopartners-calling-partner-centerapis"></a><a name="9"></a> Recordatorio: Presentación de la limitación de API para los partners que llaman a las API del Centro de partners 
...
## <a name="security-compliance-and-identity-sci-launches-coming-on-february-1-2021"></a><a name="8"></a>Lanzamientos de seguridad, cumplimiento e identidad (SCI) a partir del 1 de febrero de 2021 
...
En enero, se incluirán varios lanzamientos de Microsoft 365 en la versión preliminar de la lista de precios, los cuales pasarán a estar disponibles a partir del 1 de febrero de 2021.
...
#### <a name="microsoft-365-g5-compliance-component-skus-for-government"></a>[SKU del componente de cumplimiento de Microsoft 365 G5 para la administración pública](/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-tenantlevel-services-licensing-guidance/microsoft-365-security-compliance-licensing-guidance)

Lanzaremos tres nuevas ofertas de componentes para los clientes de Government Community Cloud (GCC) y GCC High, que estarán disponibles a partir del 1 de febrero de 2021. Estas SKU serán equivalentes a las ofertas Gobierno y protección de la información de Microsoft 365 E5, Administración de riesgos internos de M365 E5 y eDiscovery y auditoría de Microsoft 365 E5, que actualmente están disponibles en el mercado. 

   |**Nombre de la oferta**|**Identificador de oferta**|**Id. de material**|
   |-------------------|:------|:------|
   |Gobierno y protección de la información de Microsoft 365 E5 para GCC|9e5397ab-f309-4d90-97f3-6fb5d53074d6|8QL-00002|
   |eDiscovery y auditoría de Microsoft 365 E5 para GCC|5c9ef884-6307-47e7-a914-f5092feae51e|8RI-00002|
   |Administración de riesgos internos de Microsoft 365 E5 para GCC|11ccfdb3-80cb-4c80-8146-c9775045df17|8RF-00002|
   |Protección de la información y prevención de pérdida de datos (complemento) de Microsoft 365 E5 para GCC|911d3177-53a9-42ec-a0e9-3b73fce527f0|8QY-00002|

#### <a name="10-year-audit-log-retention-add-on"></a>[Complemento de retención de registros de auditoría durante 10 años](/microsoft-365/compliance/)

Un complemento disponible con el requisito previo de Microsoft 365 E5 permitirá que los clientes conserven sus datos durante 10 años. 

   |**Nombre de la oferta**|**Identificador de oferta**|**Id. de material**|
   |-------------------|:------|:------|
   |Complemento de retención de registros de auditoría durante 10 años para EDU|879b5e1a-eaa2-4ea9-a628-0b429b2e8732|8LC-00002|
   |Complemento de retención de registros de auditoría durante 10 años|e14ce8d1-09f4-42d2-9b5e-ee85f32e7be4|8LB-00003|
   
#### <a name="frontline-worker-add-ons"></a>Complementos para trabajadores de primera línea

Desde el 1 de febrero de 2021, los clientes pueden adquirir tres nuevas ofertas de programación sobre seguridad y cumplimiento para los trabajadores de primera línea como complementos para las [SKU de Microsoft 365 F1 y F3](https://www.microsoft.com/microsoft-365/firstline-workers).

Estas ofertas de programación reemplazarán la promoción actual [Seguridad y cumplimiento](https://microsoft.sharepoint.com/teams/M365LicensingNews/SitePages/Security-and-Compliance-Promotion-for-Firstline-Workers-Update.aspx), que expirará el **28 de febrero de 2021**. A diferencia de la promoción actual, los complementos de F5 ofrecen a los clientes mayor previsibilidad a medida que aumenta el número de empleados de primera línea.

   
   |**Nombre de la oferta**|**Identificador de oferta**|**Id. de material**|
   |-------------------|:------|:------|
   |Seguridad de Microsoft 365 F5|a8fba59e-1fc2-4658-8684-5f3d0c71c490|8RQ-00003|
   |Cumplimiento de Microsoft 365 F5|6dc6cb1d-7bcb-4234-80cc-9c7a9cded044|8RL-00003|
   |Seguridad y cumplimiento de Microsoft 365 F5|ad396924-ee4e-4059-b779-efe43dfa24d2|8RU-00003|
   
### <a name="next-steps"></a>Pasos siguientes

Revise la versión preliminar de la lista de precios y compártala con las partes interesadas adecuadas de su organización. Para obtener más información, visite [Seguridad y cumplimiento de Microsoft: Microsoft Tech Community](https://techcommunity.microsoft.com/t5/microsoft-security-and/ct-p/MicrosoftSecurityandCompliance).
...
## <a name="docusign-migration-to-adobe-sign-for-partners-under-microsoft-partner-agreements-mpas"></a><a name="7"></a>Migración de DocuSign a Adobe Sign para partners con contratos de Microsoft Partner Agreement (MPA) 
...
Partners directos e indirectos actuales del programa Proveedor de soluciones en la nube (CSP) con un MPA. Los partners de Ucrania, Rusia y Kazajstán deberán volver a firmar física o electrónicamente la cláusula adicional cada año.
...
## <a name="commercial-pricing-update-for-norwegian-krone"></a><a name="6">Actualización de precios comerciales para la corona noruega</a> 
...
Partners del Proveedor de soluciones en la nube que usan la corona noruega.

### <a name="details"></a>Detalles

A partir del 1 de marzo de 2021, los precios en coronas noruegas para el software local y los servicios en línea comerciales cambiarán para equilibrarse con los niveles de precios vigentes en la región.
El anuncio completo está disponible solo para los partners de Microsoft. [Inicie sesión para obtener acceso al anuncio completo](https://partner.microsoft.com/resources/detail/pricing-update-norway-partners-pdf).

_____________ 

## <a name="commercial-pricing-update-for-the-indian-rupee"></a><a name="5"></a>Actualización de precios comerciales para la rupia india 
...
## <a name="calling-plan-and-phone-system-updates-for-february-1-2021"></a><a name="4"></a>Actualizaciones del plan de llamadas y del sistema telefónico para el 1 de febrero de 2021
...
## <a name="license-base-price-list-updates-for-january-2021"></a><a name="3"></a>Actualizaciones de la lista de precios basados en licencias para enero de 2021 
...
- Los problemas de precios de Microsoft 365 E3 se limitaron solo a estas monedas: Yen japonés (JPY), libra esterlina (GBP), Unión Europea (EUR), dólar australiano (AUD). 
- Los problemas de Microsoft 365 Business Basic se limitaban solo a los dólares estadounidenses (USD). 
...
Partners que venden ofertas académicas mediante el programa Proveedor de soluciones en la nube mediante la API del Centro de partners
...
## <a name="dynamics-365-offers-for-february-2021"></a><a name="1"></a>Ofertas de Dynamics 365 para febrero de 2021
...
Se lanzarán nuevos cambios en la oferta de Dynamics 365 en febrero de 2021.
...
Microsoft anuncia nuevos cambios en la oferta de Dynamics 365 que se lanzarán en febrero de 2021 para:

- Additional Response de Dynamics 365 Customer Voice
- Final de ciclo de vida de Dynamics 365 Customer Service Insights
- Cambio en los identificadores de la oferta de migración de Dynamics 365 Cloud AX
...
El 1 de febrero de 2021, los siguientes productos pasarán al final de su ciclo de vida:

- Dynamics 365 Customer Service Insights (incluidos los "casos adicionales")
- Dynamics 365 Virtual Agent for Customer Service

La experiencia independiente "Customer Service Insights" se trasladará a "Dynamics 365 Customer Service", donde los clientes encontrarán las mismas funcionalidades perfectamente integradas en las experiencias de servicio al cliente.  

Consulte la pestaña "Customer Voice Insights" en el [documento de Excel de ofertas de Dynamics para CSP de febrero de 2021](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) a fin de obtener información detallada sobre la SKU. Visite la [página principal de Microsoft Dynamics Customer Service](https://dynamics.microsoft.com/customer-service/overview/) para obtener más información.

**Identificadores de la oferta de migración de Dynamics 365 Cloud AX**

Estas SKU se han quitado de la lista de precios finales del 1 de enero de 2021 y no estarán disponibles para realizar pedidos en este momento. 

   |**Nombre de la oferta**|**Identificador de oferta**|
   |-------------------|:------|
   |Programa Dynamics 365 Finance for AX Migration|7fbd1115-a4c1-4cf9-b881-40c4187ca581|
   |Programa Dynamics 365 Supply Chain Management for AX Migration|a3c62c0e-4f8a-4fc9-a47e-dec3310529d0|
   |Programa Dynamics 365 Commerce for AX Migration|97e98de6-24a8-4282-bad6-9d1a874e90a4|
   |Programa Dynamics 365 Finance Attach to Qualifying Dynamics 365 Base Offer for AX Migration|69d789e8-1e93-4dee-86b2-3ddfb03c08b9|
   |Programa Dynamics 365 Supply Chain Management Attach to Qualifying Dynamics 365 Base Offer for AX Migration|c897adce-2964-4d24-abc3-7f7ad4b6a80d|
   |Programa Dynamics 365 Commerce Attach to Qualifying Dynamics 365 Base Offer for AX Migration|ba1fe561-cfda-405a-a25d-ecda3bd3cba7|
   |Programa Dynamics 365 Operations – Activity for AX Migration|177e954e-1fff-4941-8967-55a47e36e1ce|
