...
**Los principales**  subsegmentos de empresas medianas y no administradas representan clientes de alto valor de tiempo de vida (LTV) para Microsoft y asociados de Microsoft. Por este problema, son las principales áreas de enfoque para impulsar el crecimiento en este segmento. En estos dos subsegmentos, estamos mejor posicionados para adquirir el socket con Microsoft 365, monetizar aún más con las aplicaciones de línea de negocio (LOB) de D365/Azure y conseguir una alta LTV para Microsoft.

Hoy en día tenemos dos áreas clave de oportunidad: 1. nuestro cliente agrega crecimiento; 2. aunque se adquieren bien los sockets en la nube Microsoft 365, tenemos una gran oportunidad en Dynamics 365 y Azure.

La captura de pantalla siguiente representa los cuatro subsegments de SMB. CloudAscent da prioridad a la generación de perfiles, la puntuación y el modelado de todas las cuentas principales no administradas y medianas.

:::image type="content" source="images/pci/cust-oppor-32.png" alt-text="Captura de pantalla de los subsegmentos smb.":::

## <a name="cloudascent-machine-learning"></a>CloudAscent Machine Learning

SMB usa la tecnología de aprendizaje automático para impulsar las predicciones de los clientes de ventas y marketing dentro de los segmentos de negocio medio y no administrado. ¿Cómo se recopilan y convierten las señales en recomendaciones de propensidad?
...
3. Agrupación en clústeres
   ...
   La **pestaña Modelo de propensidad** de los libros CloudAscent comparte la propiedad y los ingresos estimados del espacio en blanco. Para definir la agrupación en clústeres de Ajustar e Intención, se van a seguir estos pasos:
      ...
      1. Con los modelos de ML, calculamos primero la puntuación de ajuste del cliente y la puntuación de intención en una escala de 100.  Las puntuaciones exactas variarán en función de los modelos de ML.  Puntuaciones de ejemplo siguientes:
      ...
      2. Con la regla anterior, clasificamos las empresas como Alta, Media, Baja y Muy Baja en las señales de ajuste del cliente y de intención.
...
Estos clientes ya tendrán Azure o Microsoft 365 y el modelo de ventas superiores muestra que es probable que compren más de su SKU existente.
