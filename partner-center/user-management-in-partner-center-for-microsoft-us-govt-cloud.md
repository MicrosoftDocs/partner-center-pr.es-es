...
Si ha iniciado sesión en el centro de partners para Microsoft Cloud para el gobierno de EE. UU., puede abrir el Azure Portal de Microsoft Cloud para el gobierno de EE. UU. sin tener que volver a iniciar sesión. Sin embargo, si necesita iniciar sesión directamente en el Azure Portal para Microsoft Cloud para el gobierno de EE. UU., vayahttps://portal.azure.us/) a (e inicie sesión con las credenciales de administrador global del inquilino de Azure AD para Microsoft Cloud para el gobierno de EE. UU.
