...
|Cuenta de Centro de partners|El identificador de MPN asociado al inquilino Centro de partners debe ser el mismo que el identificador de MPN asociado a la solución de venta simultánea. Antes de implementar los conectores, compruebe que puede ver las referencias de venta Centro de partners portal.|[Administración de la cuenta](create-user-accounts-and-set-permissions.md)|
...
1. En la **lista desplegable Entornos** de la esquina superior derecha, seleccione la instancia de CRM donde instaló la solución Power Automate cliente.
...
1. Seleccione el flujo Centro de partners registro **de webhook (versión** preliminar de Insider Power Automate) y, a continuación, **seleccione Ejecutar**.
...
- **Código de país de la** cuenta de cliente: es obligatorio proporcionar un código de país de dos letras (ISO 3166) al crear una nueva referencia. De forma predeterminada, el código de país se sincronizará con y desde el campo de address1_country **de** la cuenta en CRM. Si tiene un campo diferente en crm para el código de país desde el que se va a sincronizar:
   ...
   - Para un campo de código de país que no sealookup de la cuenta que contiene un código de dos letras:
     ...
     - Editar [Personalizar] Cree u obtenga detalles del flujo de  **Dynamics 365** y vaya **a** Crear u obtener cuenta de cliente en la acción CRM para asignar un valor de País al campo correcto en CRM. Además, quite la **asignación de** valor País del **campo Dirección 1: País o** región.
...
1. Sincronización de referencias cuando se crea o actualiza la referencia en CRM y se sincroniza en Centro de partners:
   ...
   1. Una vez creada la oportunidad en Dynamics 365 con la opción Sincronizar con **Centro de partners** establecida en Sí, espere 10 minutos. A continuación, inicie sesión en Centro de partners cuenta. Las referencias se sincronizarán con Dynamics 365 y el **identificador de referencia**. **El vínculo de** referencia se rellenará. Si se produce un error, el **campo Auditoría** se rellenará con información de error.
    ...
    1. Del mismo modo, para una oportunidad que tenía la opción Sincronizar con **Centro de partners** establecida en Sí, si actualiza la oportunidad en Dynamics 365 CRM, los cambios se sincronizarán en la cuenta de Centro de partners.
