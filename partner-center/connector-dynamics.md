...
description: Sincronice las referencias Centro de partners con el conector de venta en colaboración para Dynamics 365 CRM. A continuación, puede realizar la venta en colaboración con Microsoft desde el sistema CRM.
ms.topic: how-to
...
Centro de partners conectores de venta en colaboración permiten a los vendedores vender en colaboración con Microsoft desde dentro de sus sistemas CRM. No tendrán que entrenarse para usar Centro de partners administrar ofertas de venta en colaboración. Use los conectores de venta conjunto para crear una nueva referencia de venta conjunto para atraer a un vendedor de Microsoft, recibir referencias del vendedor de Microsoft, aceptar o rechazar referencias y modificar datos de oferta, como el valor de la oferta y la fecha de cierre. También puede recibir cualquier actualización de los vendedores de Microsoft sobre estas ofertas de venta coventa. Puede administrar todas las referencias en el CRM de su elección en lugar de en Centro de partners.
...
|--------------|--------------------|------|
|Identificador de Microsoft Partner Network (MPN) |Necesita un identificador de MPN válido.|[Unión a Partner Network](https://partner.microsoft.com/)|
...
## <a name="install-partner-center-referrals-synchronization-for-dynamics-365-power-automate-solution"></a>Instalación Centro de partners de referencias para Dynamics 365 (Power Automate solución)
...
1. Busque Centro de partners **conectores de referencias para Dynamics 365** en la pantalla emergente.  
...
1. Deberá crear conexiones que asocie las tres cuentas de usuario:
   ...
   1. A continuación, cree una Centro de partners eventos para el Centro de partners con las credenciales de administrador de referencias.
...
1. Vuelva a  la página Soluciones, seleccione sincronización de referencias de Centro de partners para **Dynamics 365** y active el flujo seleccionando el icono de puntos suspensivos junto a cada flujo de la secuencia siguiente. Si encuentra algún problema al activar el flujo, vea Pasos [de personalización](connector-dynamics.md#customize-synchronization-steps) y [Pasos de solución de problemas.](connectors-troubleshoot.md)
...
1. Seleccione **Ejecutar flujo** y, a continuación, seleccione **Listo.**
...
- **Código de país de** la cuenta de cliente: es obligatorio proporcionar un código de país de dos letras (ISO 3166) al crear una nueva referencia. De forma predeterminada, el código de país se sincronizará con y desde el campo de address1_country **de** la cuenta en CRM. Si tiene un campo diferente en crm para el código de país desde el que se va a sincronizar:
  ...
  - Para un campo de código de país que no sea de búsqueda en la cuenta que contiene un código de dos letras:
    ...
    - Edite [Personalizar] Cree u obtenga detalles del flujo  de **Dynamics 365** y vaya **a** Crear u obtener una cuenta de cliente en la acción CRM para asignar un valor país al campo correcto en CRM. Además, quite la **asignación de** valor País del **campo Dirección 1: País o** Región.
...
- Campos de clientes potenciales:  si hay campos obligatorios en Clientes potenciales que deben rellenarse, edite  [Personalizar] Crear u obtener detalles del flujo de **Dynamics 365** y vaya a Crear o actualizar clientes potenciales en CRM y actualice Crear una nueva acción de cliente potencial para asignar valores **a** los campos obligatorios en función de sus requisitos empresariales. 
...
Después de instalar, configurar y personalizar la solución Power Automate, puede probar la sincronización de referencias de venta Power Automate entre Dynamics 365 y Centro de partners.
...
- **Productos: obsoletos:** no use este campo ni agrégrelo a la sección CRM. Solo está disponible para compatibilidad con versiones anteriores. Use Centro de partners soluciones en su lugar.
