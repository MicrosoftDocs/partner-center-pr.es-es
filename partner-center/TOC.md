...
# Unirse a un programa de partner
...
## [Mover los clientes de servicios basados en licencias al Programa Proveedor de servicios en la nube en el Centro de partners](transition-seat-based-services.md)
...
## [Obtener datos y analizar tu negocio](data-analysis-lp.md)
## [Aplicación de análisis del Centro de partners para Microsoft Power BI](power-bi-app-for-direct-partners.md)
