...
### [Preguntas frecuentes: Uso de la herramienta de validación y canje de vales](vvr-faq.md)
### [Servicios de planificación de Software Assurance del Centro de partners ](software-assurance-dps.md)
...
## [Nuevos requisitos de partners directos del CSP](direct-partner-new-requirements.md)
## [Contratos de Microsoft Cloud por región e idioma](agreements.md)
##[Transición desde partner de factura directa del Proveedor de soluciones en la nube (CSP) a revendedor indirecto de CSP](transition-direct-to-indirect.md)
## [Contratos, listas de precios y ofertas del CSP](csp-documents-and-learning-resources.md)
...
### [Introducción sobre el pago de reclamaciones de incentivos](incentives-payouts.md)


# [Facturación e impuestos](billing.md)
## [Preguntas más frecuentes de facturación](faq-about-new-billing-features.md)
## [Conceptos básicos sobre facturación](billing-basics.md)
## [Descripción de los tipos de facturación en el centro de partners](billing-different-types.md)
