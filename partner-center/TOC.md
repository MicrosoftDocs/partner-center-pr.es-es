...
## [Transición de PMC al Centro de partners](pmc-to-partner-center.md)
...
## [Transición de partner directo del Proveedor de soluciones en la nube (CSP) a revendedor indirecto del CSP](transition-direct-to-indirect.md)
## [Inscribirse como proveedor del Panel de control](enroll-as-cpv.md)
###[Debes habilitar Multi-Factor Authentication (MFA) en el inquilino para acceder a esta página](enable-mfa.md)
...
## [Verificar tu propiedad de un dominio](become-global-admin.md)
...
## [Programa Proveedor de servicios de Microsoft de experto en Azure](azure-expert-msp.md)
...
# [Conectar con clientes](customer-accounts.md)
...
### [Cambio de tamaño de la VM para el uso máximo de reserva](azure-usage.md)
...
### [Migrar Dynamics 365 y el plan Customer Engagement desde las versiones básicas (ofertas calificados) a versiones más recientes](manual-subscription-migration.md)
### [Migrar ofertas de Dynamics 365 Business Edition a versiones más recientes](migrate-dynamics-365-to-new.md)
### [Migrar de suscripciones de Office 365 Enterprise E4 a versiones más recientes de Office 365](migrate-office365-e4-subscriptions-to-newer-versions.md)
...
## [Contribución de partners: mantenerse en la parte superior de los indicadores de rendimiento](partner-contributions.md)
## [Obtener datos sobre el uso de las suscripciones de Azure de tus clientes](analyze-azure-usage.md)
## [Analizar el rendimiento de revendedores indirectos](analyze-indirect-resellers.md)
...
# [Obtener soporte de Microsoft](support-from-microsoft.md)
