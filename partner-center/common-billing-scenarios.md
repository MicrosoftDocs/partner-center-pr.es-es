...
---
# <a name="common-billing-scenarios-for-csp-program-partners-working-in-partner-center"></a>Escenarios comunes de facturación para asociados del programa CSP que trabajan en Centro de partners
...
En estos artículos se explica lo que debería esperar ver en la factura después de agregar nuevas suscripciones, ajustar el número de licencias a una suscripción o cancelar una suscripción. Otros [Centro de partners de facturación,](./billing-basics.md)como las suscripciones basadas en el uso y las basadas en licencias, se facturan de forma diferente.
...
| [Facturación anual](common-billing-scenarios-annual.md) | Agregar nuevas suscripciones, agregar licencias antes de la fecha de facturación, cambiar la cantidad de licencias y suspender y reactivar suscripciones. |
| [Facturación por única vez y selección de compras periódicas](common-billing-scenarios-onetime-recurring.md) | Comprar suscripciones, agregar más suscripciones, agregar y quitar licencias. |
| [Facturación de suscripciones SaaS basadas en licencias](common-billing-scenarios-saas.md) | Pruebas gratuitas para suscripciones de software como servicio (SaaS) basadas en licencias. Compra y cancelación de suscripciones SaaS de medidores personalizados. |