...
>[!IMPORTANT]
>En este artículo se explica cómo empezar a usar las ventajas de la pertenencia a Microsoft Partner Network (MPN) en el centro de Partners: este sitio. Si no ha recibido una invitación para trasladar la información de su empresa del centro de pertenencia del asociado (PMC) al centro de Partners, debe seguir administrando las ventajas de la pertenencia a MPN en PMC. [Iniciar sesión](https://partner.microsoft.com/_login?authType=OpenIdConnect) ahora en el PMC.
...
## <a name="manage-your-membership-benefits-in-the-partner-center"></a>Administrar las ventajas de la pertenencia en el centro de Partners
...
>[!IMPORTANT]
>Aunque no tienes que ser un administrador global de la organización para comprar beneficios, tienes que ser el administrador global para asignar beneficios a los empleados. Si es necesario, puede convertirse en administrador global siguiendo las instrucciones que aparecen en la página de [ **beneficios** ](https://partnercenter.microsoft.com/pcv/partnership/benefits) (es necesario iniciar sesión). Es posible que su empresa ya tenga un administrador global, por lo que debe asegurarse de comprobarlo con su equipo.

Los paquetes de beneficios incluyen asignaciones de software con licencia, servicios en la nube, suscripciones de Visual Studio y soporte técnico. Los paquetes de beneficios también pueden incluir algunas ventajas de comercialización. Puedes obtener detalles de la suscripción de Action Pack en el sitio de [Microsoft Partner Network](https://partner.microsoft.com/membership/internal-use-software).  

Para ver y administrar todas las ventajas de la suscripción, vaya a la página de [ **beneficios** ](https://partnercenter.microsoft.com/pcv/partnership/benefits) (es necesario iniciar sesión). Como alternativa, puede iniciar sesión en el [Panel](https://docs.microsoft.com/partner-center/)del centro de Partners, seleccionar la**opción [beneficios**] en el menú de la izquierda y, a continuación, seleccionar las opciones de beneficios que se muestran.  
...
#### <a name="manage-go-to-market-benefits"></a>Administrar las ventajas de comercialización
...
1. Seleccione las **ventajas de comercialización** para ver la lista de ventajas de comercialización de Microsoft.

    Las [ventajas](mpn-learn-about-go-to-market-benefits.md) de comercialización ofrecen recursos de marketing adicionales y ayuda que puede estar a su disposición. Los tipos de ventajas disponibles dependen de su nivel de socio específico y de las competencias que ya haya obtenido.

2. Para activar cualquier ventaja de comercialización, primero debe asignar un contacto de marketing de la empresa. Este contacto recibirá comunicaciones de seguimiento sobre las ventajas de comercialización activas.

3. Para agregar o actualizar la información de contacto de marketing, vaya a la parte superior de la página de comercialización y seleccione **Agregar**, **Actualizar**o **cambiar**. Ahora, haga lo siguiente:  
   
    a.  Seleccione un usuario de la lista. Si el usuario que quieres asignar no está en la lista, puedes [agregar nuevos usuarios](create-user-accounts-and-set-permissions.md) en la **configuración de la cuenta**.

    b.  Proporciona al usuario una dirección de correo electrónico que sea diferente a la dirección de correo electrónico asociada con la cuenta del Centro de partners de tu empresa. 
    
    Le enviaremos instrucciones por correo electrónico para usar las ventajas de comercialización en la dirección de correo electrónico del contacto de marketing designada. 
    
    c.  Proporcione el teléfono de contacto y el idioma preferido para este contacto de marketing. Cuando termine de escribir esta información, seleccione **asignar usuario**. 

4. Después de actualizar el contacto de marketing, busque el beneficio de comercialización que desea empezar a usar y, después, seleccione la flecha hacia abajo situada en el extremo derecho de la fila para ampliar los detalles de la ventaja. En la lista se mostrarán todos los tipos de ventajas disponibles por debajo del nombre de la ventaja (por ejemplo, **Silver Core** o **Gold Core**).

5. Seleccione **Activar** para activar la ventaja.

> [!NOTE]
>Puede tardar varios días en enviar instrucciones por correo electrónico al contacto de marketing asignado y activar una ventaja de comercialización. Una vez activada la ventaja, verá los cambios en la página de comercialización. En la columna **Estado** , verá el cambio de la ventaja en **activo**. En la columna **Expires** , verá la fecha en la que expira la ventaja. Puede usar esta ventaja hasta la fecha de expiración. Obtenga más información sobre los [diferentes tipos de ventajas de comercialización](mpn-learn-about-go-to-market-benefits.md) disponibles.  


## <a name="cancel-a-membership-benefit"></a>Cancelar una ventaja de pertenencia

Para cancelar una ventaja y recibir un reembolso, debe realizar la solicitud en un plazo de 30 días después de la compra y no haber activado las ventajas del software. Solicitar la cancelación a través de una solicitud de servicio.
...
[Más información sobre las ventajas de la comercialización de MPN](mpn-learn-about-go-to-market-benefits.md)