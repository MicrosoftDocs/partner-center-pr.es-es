...
Azure Reserved Virtual Machine Instances (RI) ahora Windows Server y SQL Server suscripciones están disponibles a través del programa de proveedor de soluciones en la nube (CSP) de Microsoft (consulte el [anuncio](https://blogs.partner.microsoft.com/mpn/better-together-azure-reserved-instances-server-subscriptions/?ln=en-us)). 
...
-   Lista de precios de las suscripciones de servidor: titulada "Suscripciones de Software" y se encuentra en la sección de **Software** de la página del centro de partners [precios y ofertas](https://commercial-licensing.eventbuilder.com/Reserved_Instances_in_CSP_May_Option_1) .
...
-   Guardar hasta 30% * en las migraciones a la base de datos de SQL de Azure con ventaja híbrida de Azure
-   Ahorre hasta un 49% en una máquina virtual IaaS de SQL por apilamiento ahorros a través de un RI, Windows Server + suscripciones de SQL
