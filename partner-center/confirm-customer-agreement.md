...
Los asociados pueden confirmar la aceptación del cliente del acuerdo de cliente de Microsoft en el centro de partners para nuevos clientes y clientes existentes. Los distribuidores no pueden atestiguar en nombre de sus clientes y necesitan trabajar con su proveedor indirecto para completar la atestación.
