...
---
# <a name="partner-security-compliance-status"></a>Estado de cumplimiento de seguridad para partners

**Se aplica a**

- Centro de partners
- Todos los partners de Proveedor de soluciones en la nube
- Todos los asesores
...
### <a name="identity-which-users-have-logged-into-partner-center-without-mfa"></a>Identidad de los usuarios que han iniciado sesión en el Centro de partners sin MFA
